...
### Road Work at a Crossing

Active Road Work changes the physical approach to RISK as well as the traffic
upon the Roadway. Each affected Staging Post takes one of two active states,
and the altered ground may remain after the workers depart.

- **Closed:** machinery, barriers, occupied ground, or an unusable far-side
  Staging Post prevents Commitment there. The party remains in TRAVEL and may
  wait, use an available Outpost, or move longitudinally beyond the affected
  run to another Crossing opportunity.
- **Altered:** the Crossing remains available, but redirected traffic,
  compressed lanes, work vehicles, noise, dust, River Spume, temporary
  material, sightlines, and changed refuge enter ordinary RISK planning and
  resolution.
- **Changed afterward:** a repaired barrier, resurfaced edge, cleared verge,
  altered drain, new obstruction, or newly exposed refuge persists after
  Withdrawal and becomes part of later Crossing conditions.

Road Work ordinarily occupies at least three contiguous Reaches, so moving one
Reach cannot bypass a closure. A party already beyond the closed Roadway
remains at its actual Field position and chooses whether to wait, Stopover, or
travel toward an unaffected opportunity; it is never extracted automatically.
If active work changes state after **Commit**, the Continuous Run still carries
the whole party to the far side. RISK applies the changed condition and any
penalty only after passage, never by suspending the party in the Roadway.
...
Road Work, litter, runoff, noise, light, and sudden disturbance. Human bodies
