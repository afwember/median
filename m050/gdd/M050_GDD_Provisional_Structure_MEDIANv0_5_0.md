...
Road Work is an exceptional authored World event in which human maintenance
physically occupies and alters part of the Corridor. Lane work, barrier repair,
mowing, drainage or culvert clearance, resurfacing, staged material, and
machinery provide possible content without becoming formal event families.
Animals experience its approach and footprint like a storm front while its
cause remains active human work.

- Markings, equipment, cut vegetation, altered traffic, staged material,
  sound, light, vibration, and unusual human schedules Telegraphing its arrival
- Road Work proceeding even when every Civic Balance axis is Covered; Readiness,
  Practice Strength, preparation, and relevant Signatures determining available
  responses, protected stakes, costs, and consequences rather than cancelling
  the event
- Active Road Work becoming the Colony's primary MEET subject and producing
  consequential situations more frequently than ordinary Pressure, with each
  MEET advancing the work, changing its footprint, or presenting a new stake
- A normal footprint closing access to one Margin side across at least three
  contiguous Reaches: the directly affected Reach and its immediate
  longitudinal neighbors
- That short run preventing the player from bypassing the work by moving only
  one Reach, while larger footprints remain authored consequences rather than
  the default closure of an entire known Corridor
- Crossings within the footprint becoming Closed or Altered during active work
  and retaining any physical changes after access reopens
- Traffic, River Spume, sound, vibration, light, drainage, vegetation, paths,
  Nodes, Roadway edges, Places, and Spatial Alignment changing where the work
  physically reaches them
- A Node able to disappear, transform, recover differently, or be revealed when
  its underlying ground changes, with its former state remaining in the Record
- Human timing governing Withdrawal; the player protecting, relocating, or
  adapting what matters rather than defeating the work itself
- A rare personal MEET able to bring the Founding Escape back through the body
  of one surviving Founder, as detailed in Appendix F

Road Work follows the shared event arc below. Its Impact is the onset of active
work; its Persistence may include several advances and a final human
Withdrawal before the altered ground enters Aftermath.
...
The Colony is DWELL's mechanical subject, but every Citizen remains named and
visible within its collective accounting. The player reads and arranges Home
through Places, Practices, Roles, Projects, resources, and situated conditions.
An elevated, freely navigable view makes material, civic, and social state
legible without reducing DWELL to its camera.

### Attention and time

Routine information and continuing work remain native to DWELL rather than
seizing attention. Looking, reading, planning, and moving the camera consume no
time; a meaningful Home commitment advances the shared clock by one Day Band,
and DAWN resolves the completed day while surfacing only meaningful change.
Launch and Homecoming connect DWELL to Away through MEET.

### Civic Balance: Shares, Load, Readiness, and Pressure

**Civic Balance** describes whether the Colony can carry the weight created by
its own growth. Housing and each Role remain separate responsibilities, so
strength in one domain never conceals a shortfall in another. Citizens direct
their Civic Shares either to ordinary Role coverage or to Projects. Practices
add situated physical support, but neither perform labor nor advance Projects
without Citizens.

#### Shared balance grammar

Each axis compares Capacity with its full Load. Surplus becomes **Readiness**,
an exact match is **Covered**, and uncovered Load becomes **Pressure**. An axis
with no present obligation is N/A rather than an empty post the player is
expected to fill. Pressure therefore names a specific vulnerability, not a
single Colony-wide deficit.

#### Role Balance

**Civic Share** is Body-Unit-normalized ordinary civic contribution: Rabbits,
...
Core Citizens create Housing Load by Body Unit. A normal Residence supports two
Body Units; a Well-Placed one supports three. Thus the same Residence houses
two Rabbits or Squirrels—or four Mice—and good placement raises those numbers
to three or six. Lost capacity creates Housing Pressure but never evicts a
Citizen. Guest housing remains separate and follows each species' Residence
Fit.

#### Readiness and Pressure

Role Readiness is the Civic Share remaining after that Role's present Load is
covered; Role Pressure is whatever remains uncovered. Both stay attached to
their Role. Readiness supports stability and better response without granting
immunity from events or consequence.
...
The separate Housing and Role Pressures form a **Civic Pressure profile**.
**World Pressure** supplies external conditions. A hidden, momentary **Colony
Pressure** calculation weighs both with current circumstances, persistence,
bounded randomness, and recent Home MEETs to decide when vulnerability becomes
a situation. The strongest relevant shortfall normally supplies its primary
civic stake; another shortfall or the actual Citizen, Place, relationship,
resource, or environmental circumstance supplies the collateral stake.
Pressure creates vulnerability rather than automatic daily damage.

#### Practice Strength

A completed usable Practice has situated **Practice Strength** when a situation
meaningfully involves it. Its committed physical order contributes even when
Role support is thin; compatible Civic Shares strengthen it, and good Species
placement adds the important Spatial Alignment bonus. Support aggregates
automatically, with no Citizen-to-Practice linking. Practice Strength helps
shape a situated response but never erases standing Role Load.

#### Civic choice and Projects

Each available Citizen directs their Civic Share either to ordinary Role work
or to an active Project. Commitment advances lasting change while withdrawing
that share from Role coverage, Practice support, and any passive throughput.
Several Citizens may divide a Role's effort between continuity and change, but
infrastructure alone never advances a Project.

#### Passive production and transformation

Passive output exists only where a Role and Practice define one, and requires
both a usable relevant Practice and an actual Citizen sustaining the production
Role. Practices, sustaining Civic Shares, and good placement add to throughput;
fractions accumulate until DAWN releases whole chunks. Projects, inputs,
reserves, recipes, and season then create meaningful tradeoffs. The relationship
never invents output for a Practice that defines none.

### Quiet and consequential attention

A well-sustained Colony remains in DWELL without compulsory intervention.
Pressure stays ordinary information until stakes, choice, and consequence bring
a bounded situation into MEET. **Quiet Equilibrium**, Home's sole tracked
condition, becomes active while ordinary obligations are covered and no acute
situation demands attention. It opens EMBODY without becoming a resource or
reward; observation and voluntary Projects remain available regardless.
...
established Place may stand vacant or hold one Residence or Practice. Only an
explicit Guest exception departs from that rule. Species placement determines
how effectively the established use serves the Colony.

### Place uses

An established Place retains its location, footprint, physical condition,
species relationship, history, and use. A Practice gives the Place its
functional name—Garden, Hearth, Workshop—without a separate building type. The
same Practice keeps the same civic purpose across Core Species even as its form
changes. Places may become vacant, damaged, adapted, or transformed, but
lasting consequences remain attached to that ground. Development always makes
a specific new fact true rather than leveling the Place automatically.

### Builder designates Places

Designation costs no material, effort, or time and produces no civic benefit by
itself. Establishing a Residence or Practice requires a Builder Project; its
commitment makes the Place permanent, and its unfinished use supplies no
Capacity, strength, or output. Completion makes that use available. The first
Workshop is the sole bootstrap exception. Builder makes the physical fact but
does not own the completed Practice or later Role-specific adaptation.

### Core Residence

A Residence is an inhabited use of Place, not a Practice. Its Body-Unit
Capacity answers the Housing Load of accepted Citizens without granting or
withholding belonging. Shortfall creates Housing Pressure and never eviction.
Core Residences share the capacity relationship introduced in DWELL; Guest
residences occupy dedicated Places and follow the Residence Fit of their
species unless that species defines a specific Practice-sharing exception.
Residences supply no Practice Strength or passive output.

### Species placement

Every usable Residence and Practice is **Well Placed** or **Not Well Placed**
according to the Colony's spatial operator. Mouse **JOIN** values contact,
enclosure, and adjacency; Rabbit **GATHER** values open common space, mutual
visibility, and protective edges; Squirrel **CONNECT** values reachable nodes,
elevation, alternate routes, and redundancy. This judgment comes from spatial
relationships rather than a species-themed skin. Guest placement follows the
housing needs of the individual Guest species.

### Spatial Alignment

A Well-Placed Residence gains fifty percent more Housing Capacity. A
Well-Placed Practice gains a substantial situated-strength bonus and, where it
defines passive production, additional throughput. Alignment never replaces
the required Practice-and-Citizen gate. Because it follows the completed
layout, later growth can improve or degrade a Place—for example, by obscuring a
Rabbit court's common center. The interface previews these effects before
commitment. Placement thereby makes Species spatial identity mechanically
important without creating three parallel civic systems.

### Place development

Sustained use, season, civic need, consequence, a Guest, or the Rest-Stop
Metropolis may reveal a specific improvement. The possibility becomes directly
...
Builder carries responsibility for the physical soundness and deliberate
transformation of Home. **Workshop** is Builder's principal Practice: land,
material, access, and established methods committed to making and maintaining
the Colony's physical fabric. Other Practices may need Builder work without
becoming Builder Practices themselves.

#### The first Workshop

The Colony may establish its first Workshop without already having one. This
sole bootstrap exception still requires material, time, and committed Builder
Citizens; the unfinished Workshop supplies no Practice Strength, and its
completion ends the exception. Every later Workshop follows the ordinary
Project rules.

#### Work and vulnerability

Ordinary Builder work keeps coverings, supports, drainage, access, passages,
and connections sound. When that responsibility is covered, Home needs no
repair order for every wall or ladder. Builder Projects instead make a lasting
physical fact true: establishing a Residence or Practice, reinforcing a route
or shelter, restoring major damage, constructing an Outpost, or completing
major physical or Tier-defining work. Committed Builders leave ordinary
Readiness, so growth temporarily trades some structural assurance for lasting
change.

A Builder shortfall makes Home vulnerable to wind, water, damaged access,
failed anchors, softened ground, and structural overextension. MEET locates
that vulnerability in actual inhabited ground and normally resolves the
immediate consequence; a restoration Project follows only when physical work
genuinely remains. Tool-making belongs to Crafter. Guest Signatures may reveal
a hidden circumstance or improve a response, but they do not replace Builder
responsibility or Citizen labor.

### Gardener

Gardener carries responsibility for cultivation, seasonal yield, and the
continuing health of cultivated ground. **Garden** is Gardener's Practice: land,
soil, access, and accumulated order committed to growth. Builder establishes a
Garden through an ordinary Project after the first Workshop; an unfinished
Garden supplies neither Practice Strength nor Sustenance.

#### Passive production

Perishable Sustenance follows the shared additive production rule: usable
Gardens, sustaining Gardener Civic Shares, and Well-Placed Gardens each add to
yield. Both a usable Garden and an actual sustaining Gardener are required.
Committing Gardeners to Projects therefore reduces ordinary production as well
as Gardener Readiness. Season and situation modify the resulting yield rather
than bypassing that gate.

#### Winter Cultivation

An ordinary Garden produces no regular winter Sustenance. Learned **Winter
Cultivation** becomes real only when a Gardener Project physically adapts one
Garden. With Gardener coverage, that Garden then produces at one-quarter of
normal yield and uses the same fractional accumulation as other passive
throughput.

#### Work and vulnerability

Ordinary Gardener work tends growth, soil, protection, and continuity between
yields. Projects instead establish or reshape cultivated ground, restore
persistent damage, or make a lasting seasonal or ecological change. Builder
may supply the physical work without taking the Garden's continuing purpose
from Gardener.

A Gardener shortfall makes Home vulnerable to drought, heat, washout, crop
loss, damaged soil, poor yield, and winter shortage. MEET locates consequence
in an actual Garden, family, reserve, or threatened part of Home. Guest
Signatures may change those circumstances or open a lasting Project, but they
do not replace Gardener coverage or the production gate.

### Crafter

Crafter transforms recovered material into functional civic and Away
capability. **Workshop** supports both Crafter and Builder without becoming two
Practices or requiring Citizens to be assigned to individual Workshops. Its
protected ground, organized material, access, and established methods support
work; Citizens still perform it.
...
Tools are deliberate, durable Away-function Items rather than passive output.
Making one requires a Crafter Project, appropriate Scrap, time, a usable
Workshop, and committed Crafters. Ordinary maintenance remains covered work;
adaptation becomes a Project when it makes a new persistent fact true. Crafter
Projects may also establish a lasting fabrication capability or defined civic
artifact. Collaboration never changes which Role owns the intended result.

#### Fine Work

**Fine Work** is a Workshop improvement that opens Specialist Tools. Each has a
specific authored capability beyond the five ordinary Tool classes, its own
learned recipe, and its own Crafter Project. Specialist Tools are reproducible,
individually held one-slot Tools rather than singular Special Artifacts. Fine
Work increases neither ordinary throughput nor Project capacity.

A Crafter shortfall makes Supplies unavailable, Tools or substitutions fail,
or material become disordered when a particular need arises. MEET situates the
consequence rather than imposing routine breakage or fabrication chores. Tools
remain made for work rather than violence. Guest Signatures may reveal a
material possibility or response, but they do not bypass recipes, Projects, or
Crafter responsibility.
...
Watchkeeper carries the singular civic responsibility of noticing pressure
early enough for deliberate response. It governs warning and Telegraph rather
than generalized defense, and any number of available Citizens may sustain it.

#### Watchpost

**Watchpost** is Watchkeeper's sole Practice. It preserves sightlines and
listening lines, known approaches, warning markers, protected observation, and
communication into inhabited Home. Edges, routes, and high or listening points
are circumstances of Watchpost rather than additional Practices. Basic watch
is possible before one exists, so Watchpost needs no bootstrap exception.

#### Standing responsibility

Ordinary watch attends Home's approaches, water, human activity, predators,
route obstruction, weather, and unusual sound, vibration, scent, or absence.
Adequate Readiness produces earlier, clearer, better-localized Telegraph and
better circumstances for response. It supplies useful time and information,
not exact probabilities or prevention. Project-committed Watchkeepers leave
ordinary warning, while temporary observation or forecast work remains a civic
commitment unless it creates a persistent result.

#### Watchkeeper Projects

Watchkeeper Projects adapt Watchpost, extend warning to new inhabited ground,
establish or restore a lasting signal, or answer a recurring pressure. Builder
or Crafter may support the physical means without taking the Project's warning
purpose from Watchkeeper. Once warning is adequate, the Role has no compulsory
repeatable Project.

#### Far Warning

**Far Warning** improves one Watchpost to identify the family of an eligible
approaching pressure early enough for another preparation window. It remains
qualitative: no exact probability, countdown, location, severity, or guarantee
that every pressure can be seen.

A Watchkeeper shortfall makes warning late, incomplete, or badly localized,
narrowing the Colony's response before pressure reaches inhabited ground.
MEET locates that consequence in the Place, route, Residence, Practice, or
Citizen at risk. Shortfall never permits catastrophic loss to occur unseen
while the player is Away. Watchkeeper is neither guard nor combat class;
Resident Signatures may create distinctive warnings or responses without
replacing ordinary watch.
...
**Community Board** improves one Gathering Place by giving selected Almanac
information already known to the Colony persistent shared expression in DWELL.
Its physical board may stand elsewhere in Home while remaining part of that
...
Each completed usable Practice accommodates one active Project, so the Colony's
physical development creates its capacity for deliberate change. The
supporting Practice and target may be different Places: a Workshop can support
a Builder establishing a Garden elsewhere, for example. Multiple suitable
Practices permit concurrent Projects, but no Practice advances one without
committed Citizens. Builder's first-Workshop exception is the sole bootstrap.
...
Before commitment, the interface shows the resulting loss of Role coverage,
Practice support, and passive throughput; reserved material can still be
released. Commitment occupies the Practice and withdraws the named Citizens
from ordinary work. Their Civic Share-Days accumulate until DAWN records whole
progress. A committed Project cannot be cancelled or interrupted. Completion
...
Its families include atmosphere; water and ground; biological life; human
maintenance; and traffic or machinery. Biome, Season, Day Band, and special
events change their intensity, duration, forecastability, and footprint rather
than creating separate engines. Home adjudicates them only at meaningful state
changes. Severe Pressure can open MEET even in a Covered Colony, while a civic
shortfall can become consequential under otherwise ordinary conditions.

Road Work is the defined exception to ordinary absorption. Once active, it
supplies the Colony's primary MEET thread regardless of Civic coverage. The
Colony's Readiness and situated strengths change what the player can protect
and what each response costs; they do not reduce active human work to a routine
DWELL report. Ordinary Pressure situations wait while the episode advances,
while Homecoming and urgent independent situations may still require their own
MEETs. Active Road Work is an acute situation, so Quiet Equilibrium and EMBODY
resume only after the work has withdrawn and its immediate demands have been
settled.

### Bringing Pressure into focus

World conditions establish plausible situation families; the Civic Pressure
profile shows where they may find purchase. Hidden Colony Pressure recalculates
at meaningful checks, using bounded randomness and campaign history so timing
remains uncertain but causal. Recent deficiencies and situation families are
temporarily damped to prevent mechanical repetition, while persistent problems
may return later with deeper stakes. The leading shortfall supplies the primary
stake; another weakness or concrete circumstance supplies the collateral one.
Readiness and the involved Practice then help decide whether the test remains
an ordinary report or enters MEET.

### Telegraph and rebalancing

Watchkeeping is the general source of **Telegraph**; Guest Signatures may add
bounded species-specific warning. Telegraph identifies an observable family,
urgency, exposed Roles, or relevant Places without exact probabilities. When it
arrives early enough, the player may reassign uncommitted Civic Shares, adjust
Provisioning, prepare, or knowingly accept the risk. This can change the coming
situation without guaranteeing control. The Almanac holds all known Telegraph;
Community Board may mirror it inside DWELL but creates none.

### Choosing through Home MEET

A Pressure-driven Home MEET ordinarily asks the player to protect the primary
stake, protect the collateral stake instead, or endure the situation and accept
their combined consequence. Immediate cost, protected value, and likely result
remain legible before commitment. This three-response shape belongs to Pressure
situations rather than every Home conversation or ceremony, and resolving it
consumes world time.

### Consequence and aftermath

Home danger remains part of ordinary civic life rather than becoming a defense
mode. Roles, Readiness, Practices, warning, resources, and Signatures shape the
response; consequence attaches to named Citizens and persistent parts of the
world. Injury, displacement, grief, death, or lasting change occurs only when
the situation and choice support it, and catastrophic loss never happens unseen
because attention is Away. Resolution completes the immediate situation, but
underlying Pressure remains until an actual state change restores Balance. A
Project follows only when a persistent result genuinely remains to be made.
...
suited to the Role, Species, Place, and recent history. Frills appear during
Quiet Equilibrium when necessary, persist thereafter, and may invite EMBODY.
They are mechanically inert, allowing non-producing civic work to leave a
visible trace without becoming another optimization economy.
...
It consumes Sustenance, resolves active transformations and spoilage, releases
whole passive yields, advances Beautification and Projects, resolves recovery,
...
The **Colony Roster** includes every living named Citizen who belongs, including
young Citizens, Guests, Patients, and those Away. **Citizens at Home** identifies
who is present; **Available Civic Population** identifies who can sustain Roles
or Projects; **Dependents and Patients** identifies present lives requiring
support. Keeping these views separate prevents total population from appearing
as interchangeable labor. Absence or incapacity removes a current Civic Share,
never citizenship.

### Capability and obligation

Each available adult adds their Body-Unit Civic Share, while every new Citizen
adds needs for Sustenance, accommodation, access, care, protection,
integration, and remembrance. Young or unavailable Citizens add responsibility
before they add or recover a Civic Share. Body Units normalize civic and
material scale without making any Citizen fractional in personhood or
belonging.

### Supporting a larger Colony

A larger Colony depends on Residences, Sustenance, routes, care, Readiness, and
seasonal preparation rather than one population cap. Before planned growth,
the player sees its effects on Housing, Sustenance, Role Load, care, and Civic
Shares. Emergency refuge may exceed ordinary capacity through visible Pressure
and provisional shelter, while permanent welcome remains a deeper commitment.
Growth stays optional even when support exists.

### Three paths of growth

**Wanderers** join through refuge and integration. **Nesting** adds a few named
young Citizens through a rare seasonal commitment. **Guest residency** grows
from relationship and hospitality. Each path changes the Colony's history and
obligations rather than acting as an add-population command, and usually
resolves through Home or Homecoming even when contact began Away.

### Wanderers and arrival

Wanderers are the primary early source of adult growth. Each arrives named,
with a Prior-life Tale and any relevant injury, relationship, knowledge, or
unfinished circumstance. MEET lets the Colony offer permanent welcome,
temporary refuge, help onward, or refusal according to its real capacity.
Provisional shelter makes urgent compassion possible while exposing its Load.
An integrated Wanderer becomes an equal Core Citizen; refusal enters history
without becoming automatic punishment.

### Nesting

Nesting is a rare, voluntary, green-season Colony commitment rather than
population production. During Quiet Equilibrium, particular mature Citizens
...
Hospitality requires the credible ability to house, sustain, know, and
integrate a Guest. Residency completes only when the species' Residence Fit and
agreed Terms of Hospitality become true. The welcomed Guest then enters the
Roster, adds ordinary obligations, and contributes one Civic Share while
available. Guest identity, Residence exceptions, Signatures, and the full path
to residency belong to Chapter 4.3; accepting residency remains optional at
every Tier.

### Scale and continuity

Every increase produces named Citizens with Tales and visible relationships to
Home. Mouse Colonies may become denser without making individual Mice partial
lives. Population bands guide encounter, visual, accommodation, and campaign
tuning without becoming a hard ceiling. A small stable Colony can be complete;
later loss changes present capability without erasing its history or achieved
Tier.
...
person. A **Citizen** is a named member of the Colony with a body, relationships,
belongings, history, present circumstances, and a possible future. Location,
age, injury, and availability may change while citizenship endures.

Citizens share the functions usually concentrated in a single player
character. Each carries a particular life, some of the Colony's capabilities,
and a distinct exposure to consequence; together, the Roster carries the
player's continuity through the world. They are fractional player characters
without becoming fractions of people.

The player should ideally come to feel attachment to—and something like
friendship with—particular Citizens. Appearance, voice, temperament, habits,
relationships, possessions, routines, and accumulated history create that
particularity without becoming personality scores or productivity ranks.

### One civic architecture

Core and Guest Citizens hold equal civic and historical standing through one
shared architecture:

| Aspect | Body-facing rule |
|---|---|
| **Belonging** | The living Roster records who belongs to the Colony. |
| **Location** | A Citizen is at Home or at one current Away position. |
| **Availability** | Age, injury, treatment, absence, or another real condition determines what they can presently contribute. |
| **Civic contribution** | An available adult supplies the Civic Share defined by their Body Unit. |
| **Continuity** | Names, relationships, Items, harm, memory, and death follow the particular Citizen across every Register. |

One Rabbit, one Squirrel, or one v0.5 Guest constitutes one Body Unit; two Mice
constitute one Body Unit while remaining two Citizens. Body Units normalize
Housing, Sustenance, Civic Balance, Projects, party scale, hazard, and Carry.
Names, relationships, personal Items, harm, memory, and death remain attached
to individual lives. This gives Mouse its intentional advantage in the number
of Citizens—and therefore personal Item positions—within the same aggregate
scale.

Young Citizens, Patients, absent travelers, and other dependents remain full
Citizens while their Civic Shares are unavailable. Launch, Homecoming, Project
commitment, injury, treatment, maturity, and death update location,
availability, life stage, or living status once, and that change remains true
in DWELL, EMBODY, TRAVEL, RISK, MEET, the Roster, and Campaign Memory.
Appendices E and H provide the exact Body-Unit and Citizen-state reference.

## 4.2 The Three Core Species

Mouse, Rabbit, and Squirrel are complete playable civilizations built upon the
same Citizen, Role, relationship, Item, consequence, and memory systems. Their
bodies change the spatial logic of Home and the characteristic advantage and
decision of Away without changing civic worth.

The illustrative maxim is: **Mouse Builds a Manor House, Rabbit Builds a
Cul-De-Sac, Squirrel Builds a Web.** These are images of civilizational shape;
Residence and Practice retain their shared functional names.

### Mouse — JOIN

Mouse lives at a quick bodily and mental tempo. Its rapid heartbeat and speed
of thought move attention among scent, sound, touch, nearby motion, and company
within a world immense at Mouse scale. Walls, roots, pipes, litter, and the
bases of human structures become edges to follow and sheltered spaces to
inhabit.

Mouse **JOINs** one protected interior directly to another. Adjoining rooms,
shared boundaries, and accumulated shelter create a Manor House of many small
spaces and many particular lives; adjacency itself supplies continuity without
requiring a passage between every pair of spaces.

### Rabbit — GATHER

Rabbit lives between vigilant stillness and explosive movement. Attention
reaches across sound, open ground, nearby companions, protective edges, and
the nearest refuge. Open space becomes useful when cover bounds it and a few
decisive leaps can reach safety.

Rabbit **GATHERs** around protected common space. Places face or preserve an
open center with mutual visibility and nearby refuge, forming one lived court
before another neighborhood buds from it.

### Squirrel — CONNECT

Squirrel lives through grasp, balance, reach, and continuous judgment in
motion. Trunks, branches, posts, signs, cables, fallen wood, and human
structures become footholds, anchors, lookouts, routes, and gaps.

Squirrel **CONNECTs** those points into a resilient Web. A safe Place belongs
to a network with credible onward movement and another way home when one link
fails; height without connection remains exposed isolation.

### Species expression at a glance

| Species | Body and civic scale | Home placement | Characteristic Away advantage | Characteristic decision |
|---|---|---|---|---|
| **Mouse** | 0.5 Body Unit and Civic Share per Citizen; 6 secured Carry each | JOIN adjoining protected interior | 12 secured Carry and two personal Item sets per Body Unit; a full party may contain six named Mice | which particular lives and relationships to place at risk |
| **Rabbit** | 1 Body Unit and Civic Share per Citizen | GATHER around protected common space | each Rabbit Body Unit adds an equal share of extra TRAVEL progress, reaching double progress with three Rabbit Body Units | how to use the larger practical itinerary |
| **Squirrel** | 1 Body Unit and Civic Share per Citizen | CONNECT a redundant network of anchors and routes | each Squirrel Body Unit adds 10 optional Strained Carry subject to visible Jostle risk | whether a larger possible return justifies a precarious haul |

The same bodies also change Crossing. Rabbit looks for the temporal opening and
runs one decisive line; Mouse joins three to six pavement-scale waypoints into
one continuous scurry; Squirrel commits to a flowing trajectory through moving
traffic with limited redirects. Mixed parties receive only the traits supplied
by the bodies actually present. Species advantages alter campaign flavor
without adding actions, experienced time, general aptitude, or a hierarchy of
species power. Appendices G and H hold the exact TRAVEL, Carry, Crossing,
placement, and mixed-party reference.

## 4.3 Guest Citizens

MEDIAN's world contains many more animal lives than the Colony's Core Species.
A **Guest Citizen** is a named non-Core animal welcomed through relationship
and accommodation. Kehaar in Richard Adams's *Watership Down* is a central
inspiration: a conspicuously different outsider whose practical importance
opens the way to friendship while difference remains fully visible.

Welcome grants full civic rank, a Residence, one v0.5 Body Unit, one Civic
Share, relationships, vulnerability, memory, and access to EMBODY. Each species
also carries one bounded **Signature** grounded in its body, senses, behavior,
or ecology. The Signature makes difference useful without becoming the whole
of that Citizen's identity.

### Guests at a glance

The canonical short name governs headings, tables, labels, and rules; natural
prose may use the established longer form. Expedition Guests may Launch and
receive an individually authored Home Role. Resident Guests remain at Home and
sustain the fixed Role shown below.

| Expedition Guest | Carry | Away Signature | Residence Fit |
|---|---:|---|---|
...
Hospitality begins through MEET with a named life rather than a recruitment
roll. Recognition establishes a relationship, obligation, promise, shared
interest, or unresolved tension. **Terms of Hospitality** then identify the
Residence Fit and any particular relational or safety promise required for
arrival. A Builder completes or adapts the Residence through an ordinary
Project; when the Terms are true, Arrival adds the Guest to Home and the
Roster. Acceptance, delay, refusal, and an unrealized welcome remain meaningful
campaign outcomes.

One Guest Residence ordinarily occupies one dedicated Place and houses one
Citizen. A Well-Placed Residence satisfies its single species-specific Fit as
a whole. Turtle, Bumblebees, Bat, Pigeon, and Possum instead have explicit
Signatures that incorporate their Residence into one named Practice without
creating a general mixed-use rule. Later loss of fit creates a visible
accommodation problem and may suspend a directly dependent Signature; it never
evicts the Citizen.

At Home, Guests sustain Roles, keep routines, form relationships, and appear
through movement, sound, rest, food, conversation, season, and characteristic
activity. Quiet Equilibrium can open EMBODY as a bounded species activity or a
period of Presence. Injury, absence, aging, departure, and death remain
particular and visible, while their Residences and relationships preserve what
changed.

Fireflies and Bumblebees are the two collective-bodied Citizen households in
v0.5. Each visible plurality forms one named Citizen, Body Unit, Civic Share,
Residence, Role, Signature, and continuous subject of consequence. Individual
bodies receive no separate administration; the household remains legible
through recurring formation, circulation, sound, light, and collective change.

### Expedition Guest profiles

#### **Raccoon**

Raccoon seeks dry exterior access and carries 12 secured slots. **HANDLE —
Latchwork** lets this dexterous object specialist manipulate one accessible
human-made closure or simple mechanism without revealing its contents or
guaranteeing value.

#### **Crow**

Crow occupies a high open perch, carries 9, and uses beak, feet, memory, and
experimental curiosity. **HANDLE — Trialwork** recruits one available object
for one plausible test or indirect manipulation without manufacturing a Tool
or guaranteeing the result.

#### **Gull**

Gull requires a broad open landing and carries 9 while remaining subject to
party time, Exposure, and consequence. **READ — Long View** reveals situated
context about broad geography, weather, water, traffic, or distant activity
from an eligible vantage before commitment.

#### **Fox**

Red Fox lives at a drained Colony boundary and carries 12 despite remaining
one Body Unit. **HANDLE — Carcass Claim** converts suitable matter at an
eligible carcass Node into its specified Supply as the biological counterpart
to the Render Tool effect.

#### **Weasel**

Weasel favors a narrow bank with several exits and carries 10. **INTERCEDE —
Drive Off** presses one small predator or aggressive animal away from one
immediate vulnerable stake.

#### **Hedgehog**

Hedgehog inhabits a concealed hedge and carries 8. **INTERCEDE — Living Cover**
places their defended body between danger and one injured or very small
Citizen, fragile Cargo stake, or bounded withdrawal.

#### **Snake**

Garter Snake rests in sun-warmed shelter and is the 6-Carry expedition outlier.
**SPEAK — Display** uses recognized posture, movement, and stillness to open a
fitting social response without compelling agreement.

#### **Mink**

American Mink lives at a safe waterline and carries 10. **REACH — Water Reach**
allows entry into suitable water, flooded culverts, drainage channels, or
waterlogged spaces on the party's behalf while leaving current, cold,
contamination, and consequence intact.

### Resident Guest profiles

#### **Owl**

Barred Owl inhabits a high listening hollow and sustains Watchkeeper.
**Night Sky-watch** sharpens one existing nocturnal Telegraph while Owl is
available and a Watchpost is usable.
...
American Toad moves between a wet edge and dry refuge while sustaining
Caretaker. **Wet-Ground Care** opens a Caretaker response in an eligible Garden
MEET concerning runoff, dampness, or invertebrate pressure.

#### **Fireflies**

The Firefly Family occupies dark damp flight space and sustains Leader as one
collective-bodied Citizen. **SPEAK — Lantern Procession** uses coordinated
night light to make participants easier to understand and open an eligible
win-win response.

#### **Groundhog**

Groundhog inhabits deep drained ground and sustains Gardener. **Seasonal
Telegraph** clarifies the kind of seasonal or environmental change becoming
likely early enough for civic response without predicting exact timing or
severity.

#### **Turtle**

Painted Turtle sustains Caretaker from shallow water and a safe basking place
within a Garden. **Water Garden Residence** incorporates that Residence through
an ordinary Builder Project without consuming another Place or adding yield.

#### **Bumblebees**

The Bumblebee Household sustains Gardener as one collective-bodied Citizen
within a suitable Garden. **Garden Cohabitation** saves a Place and adds 0.5
Perishable Sustenance while the host is usable and the household is available
and sustaining Gardener responsibility.

#### **Mole**

Eastern Mole inhabits visible undisturbed soil and sustains Builder.
**Subsurface Diagnosis** identifies the relevant hidden physical cause beneath
one Place or proposed Place when a Home MEET makes that ground matter.

#### **Bat**

Little Brown Bat sustains Builder from a high, dry-dark, smoke-free Workshop
roost. **Workshop Roost** incorporates the Residence through an ordinary
Builder Project without another Place, Practice Strength, output, or capacity.

#### **Pigeon**

Rock Pigeon sustains Leader from an open built ledge within a Gathering Place.
**Gathering Loft** incorporates the Residence through an ordinary Builder
Project without another Place, Practice Strength, or capacity.

#### **Skunk**

Striped Skunk sustains Watchkeeper from a downwind boundary Residence.
**SPEAK — Boundary Deterrence** projects credible toughness and opens a
favorable nonviolent response during an eligible threatening-animal Home MEET.
...
Appendix H provides the complete Hospitality, Residence, collective-body,
Signature, limitation, EMBODY, naming, and species-profile reference.

## 4.4 Relationships and Family

Citizens become particular friends, relatives, companions, rivals, teachers,
students, caregivers, and mourners. Relationships are qualitative truths with
their own histories, able to coexist and change without forming one affection
ladder.

The player creates opportunities for contact, keeps promises, offers care,
chooses responses, and places Citizens in consequential circumstances.
Citizens retain ownership of affection, trust, forgiveness, estrangement, and
other social responses. Meaningful formation, reversal, separation, or
reconciliation becomes visible through ordinary life, MEET, EMBODY, departure,
and return.

**Family** is the set of persistent family relationships among particular
Citizens. Parenthood, siblinghood, adoption, partnership, chosen kinship,
sustained care, and authored recognition may form overlapping families across
species, generations, Residences, and Guest or Core status. Cohabitation can
express family without defining it, and Hearth remains exclusively a Practice.

Relationships influence dialogue, Focus, advice, aid, hesitation, protection,
reunion, and consequence only when the current situation makes them relevant.
Any mechanical effect belongs to that event or owning system. Death ends a
Citizen's present action while their relationships, shared history, surviving
Tales, inheritance, grief, and memorial continuity endure. Appendix H carries
the complete relationship and family reference.

## 4.5 The Life Course

Every Citizen has an origin, a present life stage, and a possible future.
Founders begin with shared history; Wanderers and Guests bring Prior-life Tales;
Nesting, adoption, and authored arrival establish new named lives and immediate
relationships. Origin changes what accompanies a Citizen into Colony life,
never the standing of that life.

v0.5 uses two mechanically distinct stages: **Young** and **Adult**. A Young
Citizen is named, housed, related, remembered, and exposed to age-appropriate
Home life while adding ordinary needs and contributing no Civic Share. Rabbit
and Squirrel young each constitute one Body Unit; the usual pair of Mouse
littermates constitutes one Body Unit while remaining two Citizens.

**Maturity** is the visible transition into adult Civic Share and ordinary Role
eligibility after sufficient seasons and authored life events. It is a moment
recognized by family and Colony rather than an experience bar or training
rank. Adult age continues through appearance, movement, routine, relationships,
responsibility, memory, changing needs, and occasional authored changes to
availability; v0.5 has no universal Elder stage or lifespan countdown.

Death remains possible, rare, explicit, and visible. It removes present civic
contribution without deleting historical belonging: the Tale closes, the
Record remains, and relationships, Keepsakes, possessions, Places, routines,
grief, inheritance, and remembrance carry the particular absence forward.
Appendix H provides the complete origins, Young, Maturity, aging, and continuity
reference.

## 4.6 Personal Items and Focus

Personal Items help the player know who a Citizen is and remember what has
happened to them. They remain attached to particular lives while MEET choices
and resolution remain collective.

| Position | Eligible Citizens | Persistence | Purpose |
|---|---|---|---|
| **Keepsake** | Every Citizen | Personally persistent | Carries emotional meaning and one bounded contextual expression. |
...
Young Citizens and Resident Guests remain complete without inert Away slots.
Tools, Supplies, and Keepsakes occupy personal positions rather than Cargo;
body compatibility changes their physical form rather than creating a species
or Role proficiency system.

### Tools

A **Tool** is a persistent named working object. The five ordinary classes are
**Carry**, **Reach**, **Cut**, **Brace**, and **Render**. A relevant Tool appears
after the player chooses a MEET response; selecting it supplies one narrow
...
A **Supply** is one anonymous body-scaled object prepared for one intervention
and assigned to one Launch-eligible Citizen for an Expedition.

| Supply | Direction | Prepared by |
|---|---|---|
...
Homecoming and their positions clear.

### Keepsakes

A **Keepsake** is a persistent emotional object rooted in one Citizen's life;
an empty position remains a complete life. One narrow personal circumstance may
make it relevant after the player chooses a MEET response. Selecting it places
the holder in Focus and may soften a personal consequence, preserve a
meaningful stake, or permit a contextual response. Gifting, loss, sacrifice,
succession, replacement, and memorial display occur only through an explicit
meaning-making event.

### Focus

**Focus** identifies the Citizen whom a MEET Round naturally follows without
changing the party's collective decision.

1. The MEET presents its valid choices.
2. The player chooses an Approach.
3. Relevant Tools, Supplies, Keepsakes, relationships, Signatures, and authored
   circumstances become visible.
4. The player may choose no personal-Item expression or one Tool, Supply, or
   Keepsake expression; an applicable Signature may coexist with it.
5. The chosen expression or circumstance establishes the eligible Focus set;
   one qualifying Citizen receives Focus, chosen randomly when several qualify.

Focus governs camera, animation, principal speech or action, resolution
language, and possible Tale attribution. The player never selects or rerolls
Focus directly, and it grants no extra action, hidden contribution, success
guarantee, or protection from consequence. Chapter 1.5 and Appendix E provide
the complete Focus and Item references.
...
Leaving Home commits named Citizens to an unpredictable world. Expeditions may
answer domestic need, pursue exploration or contact, respond to a visible
world condition, or begin without a fixed objective. The player may change
direction, follow discovery, and return with a result unlike the one first
imagined.

Preparation exposes only facts the Colony could know: present Day Band,
weather, visible traffic, known terrain and passages, current bodily
conditions, Items, Carry, and the exact civic effect of departure. Unreached
Nodes, upcoming MEETs, ideal equipment, hidden requirements, and exact odds
remain undisclosed. Citizens prepare broadly rather than solving the journey
before it begins.

### The Launch MEET

The player initiates Launch from DWELL while no expedition is active. Every
mechanically eligible Citizen appears for direct selection; eligibility follows
only from Home presence, Maturity, Guest type, bodily availability, and current
commitment. Citizens neither volunteer nor refuse. The player chooses which
particular lives to expose, assigns one prepared Supply to each eligible carrier
if desired, reviews standing Tools and Keepsakes, and may revise or withdraw
before Commit fixes the party and begins TRAVEL.
...
Body Unit; Mouse occupies one-half. Party membership and Supply assignment then
remain fixed until Homecoming, and the one active expedition begins TRAVEL
through the Home Median.

### Home subtraction and elapsed contribution

Launch immediately changes selected Citizens from Home to Away. Their standing
Roles remain, but their Civic Shares, Practice support, passive throughput, and
Beautification contribution leave Home; Role Load and Residence ownership do
not. The Launch preview shows the exact resulting Role Balances, production,
and Project conflicts without forecasting later Home MEETs.

Time-based contribution accrues only during the Day Bands in which a Citizen
actually sustains the relevant Role. Each eligible Band contributes one-quarter
of the ordinary daily amount. Fractions remain unseen in their defined
accumulators until DAWN awards whole amounts and carries the remainder forward.
Homecoming restores eligible contribution from the Citizen's actual return.
Appendices E and G provide the full party, Item, subtraction, and partial-day
reference.

## 5.2 TRAVEL: The Field

TRAVEL directly drives one compact party figure through a top-down, persistent
world at animal scale. The party begins within the Home Median and may move
longitudinally through Reaches, cross smaller roads at Reach borders, cross Main
Roadways into the Margins, and approach the Sound Walls beyond them. Nodes,
Outposts, shelter, vegetation, drainage, debris, and human infrastructure
remain fixed within that geography.

> **DWELL asks:** What can this Colony sustain, and what should it become?
>
> **TRAVEL asks:** Where can this party go, and what will it encounter?

Soil, grass, roots, grade, cover, water, barriers, shoulders, culverts, litter,
weather, visibility, sound, and continuity of passage make a short human-scale
distance into substantial terrain. The Median offers relative sanctuary;
Margins offer greater abundance and disturbance; Roadways are moving barriers.
Return traverses this same world rather than selecting Home from a menu.

The party moves as one Field subject while every Citizen remains named and
inspectable. Movement, elapsed time, destination, Carry, and general burden are
party facts; bodies, Items, relationships, Wounds, Exposure, and personal
consequences remain individual. Separation requires an explicit consequence.

### Attention and time

Away remains under player operation until Homecoming. The player may inspect
Home through its information lenses, while construction, Role reassignment,
new Project commitment, and another Launch remain closed. Home's clock-bound
systems continue. A Home MEET may briefly take focus, advance shared time, and
then return operation to the party's exact persistent position; the party never
travels, activates a Node, crosses, or decides autonomously.

The Day Band is the sole unit of world time. Each Band begins with a projected
**travel span** expressed as reachable ground. Direct movement—including
detours and backtracking—consumes that span according to terrain, weather,
Cargo, bodily condition, Rabbit composition, and pushing. Pausing preserves
the exact position and remaining reach. Exhaustion advances the world to the
next Band; Night proceeds through DAWN accounting before Morning.

Brief uncontested Node use may resolve within the Band that reached it. Work
that genuinely occupies time advances the next Band, and consequential use
opens MEET. The game has no Time Mark, encounter allowance, or action-point
substitute for physical movement and situated commitments.

### Species, Carry, and range

Rabbit bodies increase normal travel span on the absolute three-Body-Unit
scale:
...
The increase extends distance within the current Day Band. Non-Rabbit bodies
apply no slowest-member penalty, and underfilling the party preserves Home
Civic Shares without amplifying Rabbit contribution.

Carry is one visible party-wide capacity for fungible Cargo. Rabbit and
Squirrel contribute 10 secured slots per Body Unit; each Mouse contributes 6;
Expedition Guests use their fixed values. More Cargo contracts projected reach
and may become a situated stake. Squirrel can accept additional Strained Carry
and its Jostle risk under Appendix E. Personal Items occupy their own positions.
Ordinary food remains abstracted Away: travelers continue to count toward Home
...
**RISK is the Away Register for crossing a Roadway.** From a **Staging Post** at
the road edge, the party reads traffic, weather, River Spume, Cargo, sightlines,
and far-side refuge, then commits to one complete bodily passage. Its schematic
view is backplated by the actual location and depicts the player party on the
left, the Roadway's moving opposition between, and the destination on the
right. The presentation is deliberately legible rather than realistic.

The player may plan and Commit, wait one Day Band, or resume TRAVEL away from
the road. Commit is the final strategic input:

> **Plan → Commit → Continuous Run → Resolve → Continue**

| Core Species | RISK asks | Planned passage |
|---|---|---|
| **Rabbit** | When does the Roadway open? | Choose a traffic window, broad line, and far-side refuge; sprint once. |
| **Mouse** | Where can continuity be made? | Join three to six body-credible pavement features; scurry through the chain. |
| **Squirrel** | How can movement flow through traffic? | Set one trajectory, one or two redirects, and a far-side anchor; complete the vector run. |

The Colony's Core Species governs the whole party's RISK grammar. Land-bound
Guests act through their actual bodies within it. Crow and Gull alone use a
parallel **Flyer** expression during the same commitment, with River Spume,
weather, visibility, launch, and landing governing a separately visible result.
Flight bypasses neither time, Exposure, nor consequence.

The Roadway never pauses for steering, reaction prompts, or a mid-road MEET.
...
finish before applying its altered condition or penalty. Appendix F provides
the Road Work reference; Appendix G provides full Crossing and Return Crossing
procedure.
...
A **Node** is a fixed, recognizable place whose material, ecology, shelter,
inhabitants, alteration, or history can matter across visits. Terrain,
infrastructure, human activity, season, and prior events establish what exists
there; approach, visibility, opposition, renewal, and present state determine
what the party can do. **Hazard** is a current condition or present animal at a
Node, while memory attaches to the place's history rather than forming another
Node type.

TRAVEL reveals and reaches Nodes. A quiet Node may remain observational, brief
uncontested use may resolve within the current Band, and time-consuming work
advances the next Band. Meaningful opposition, danger, opportunity, or change
opens MEET. Resolution updates the Node, party, Cargo, relationship, or world
directly. Material abandoned on arbitrary ground leaves play unless an authored
Node change makes it persistent. Appendices F and G provide the complete Node
reference.

## 5.5 MEET: Consequential Situations

MEET presents bounded choices for a concrete situation. Unopposed situations
show their contextual actions directly. A contested Away MEET always displays
the same five response families in order—active or visibly greyed—so the player
can read both possibility and constraint:
...
Each active family contains one response specific to the current Round. Tools,
Supplies, Keepsakes, relationships, and Guest Signatures may open or change an
eligible response; the provisional choice shows exact expressions before
Commit.

The party's shared result resolves before personal consequence. The system
then identifies Citizens causally exposed by what they used, carried,
protected, confronted, or were already suffering. A clear bearer receives the
consequence; equally exposed candidates resolve randomly. Cause, bearer, and
continuing effect appear immediately. Focus may make the same Citizen visible
but never causes or redirects harm. Chapter 1.5 and Appendix G provide the full
multi-Round, choice, expression, Focus, and aftermath procedure.

## 5.6 Exposure and Bodily Consequence

**Exposure** is a hidden per-Citizen measure from 0 through 6. A Citizen's first
RISK of an expedition sets a floor of 1 after the Crossing resolves. A
circumstance that explicitly creates Exposure normally adds one step; an
unstabilized Wound doubles that gain to two unless the same incident created
the Wound. Exposure weights genuine uncertainty toward the serious end of the
consequence range already supported by the situation:

**Exposure escalation chance = 10% × current Exposure**

One hidden check may advance the selected Citizen's result one position within
that valid range. Exposure neither chooses the causal target nor creates new
consequences, and at 6 it supplies no standing penalty to movement, Carry,
choice, Civic Share, control, or aptitude. Body, behavior, voice, narration,
and context convey the accumulating state without naming its level.

RISK first resolves Crossing consequence without pre-existing Exposure or
Wound weighting. Any Exposure awarded by that result then enters ordinary
persistence, including doubling when an earlier unstabilized Wound applies.

| Consequence | Continuing effect |
|---|---|
...
alone. Outside RISK, the hidden escalation chance is:
...
material, and Civic Share-Days remain committed. Routine construction travel
and labor are abstracted into that civic commitment, producing no Away party,
Exposure, or personal consequence. Completion at DAWN establishes the remote
...
receives its changed Citizens into shared Home life. It advances one Day Band
and follows:

> **Frame → Recognize and receive → Reconcile → Continue**

Recognition shows who returned, anyone absent, visible personal change, the
material result, and the Colony that now receives them before presenting
totals. Reconciliation then transfers Cargo, returns unspent Supplies, clears
their expedition Supply positions, preserves every resolved Item, bodily,
relational, and remembered fact, restores eligible Role contribution, and
recalculates Civic Balance and Home systems.
...
its actual concerns without rerolling, grading, or retroactively improving what
happened Away. Completion ends the expedition and restores DWELL. Quiet
Equilibrium and EMBODY return only when the Colony's resulting state supports
them. Appendix G provides the complete recognition, care, allocation,
reconciliation, and reintegration reference.
...
**Campaign Memory** is the one historical architecture through which the game
retains what happened and presents what the Colony remembers.
...
The **Record** is an incremental, machine-readable account of resolved facts.
Home and Away write to the same authority; later written or visual
presentations may select, consolidate, and translate those facts but never
replace them. The player ordinarily encounters the **Chronicle**, subject-bound
**Tales**, and evolving canon imagery rather than the underlying database.

The Chronicle expresses shared civic and cultural history. A Citizen or
meaning-bearing Item has a Tale shaped around the facts that apply to that
subject; Founders and arriving Citizens may also bring a **Prior-life Tale**
whose established facts enter the Record as known prior history. Supplies remain
anonymous units and receive no Tale.

Every Citizen has one current canon image, while the Colony uses the smallest
current representation set capable of preserving its spatial, material, and
inhabited identity. Lasting visible change may amend those images; dramatic
scenes, Register transitions, information panels, Chronicle and Tale
illustrations, Homecoming, and milestones reuse them as mandatory references
without creating new facts.

The **Almanac** stands outside Campaign Memory. It presents current state and
known, scheduled, forecast, or possible future events; resolution removes a
prospect from that view, updates the present, and writes what actually happened
to the Record. Given Names, Distinctions, rare After-names, death, departure,
destruction, and memorial continuity all follow this same factual history.
Appendix C provides the complete Record-to-Presentation and canon-image
reference; Appendix B provides naming and narrative-language rules.

## 6.2 The opening campaign

The opening campaign mechanically enacts the Founding Escape narrated in Part
0. It lets the player briefly inhabit a mature ancestral Home, then chains
...
1. **Reach 4 flash-forward.** Open wordlessly on the exhausted Founders running
   toward the final smaller Reach-border road, then return to calm before
   granting control.
...
4. **Chaos — state-transition MEET.** Animal-scale vibration, sound, dust,
   ...
   escaping Founders into focus.
5. **First flight — guided TRAVEL.** Three Rabbits or Squirrels—or four Mice—run
   upcorridor through playable Field movement.
6. **First Reach border — playable RISK.** A lightly trafficked smaller road
   teaches the chosen species' ordinary Crossing grammar and carries the party
   into Reach 2.
7. **Long escape — authored montage.** Continued TRAVEL and two Crossings
   provide brief apprehensions of Reaches 3 and 4 before returning to the
   opening composition.
8. **Final border — montage Crossing.** The party crosses into Reach 5 with
   every Founder at Exposure 6.
9. **Promising ground — Landscape Voice.** Quiet, air, ground, vegetation, and
   bodily relief resolve into the recognition that it feels good here.
10. **Founding — state-transition MEET.** The player inspects the ground,
    commits **Make Home**, establishes the first Leader, assembles the Colony's
    name, and enters ordinary DWELL before the first construction commitment.

The sequence preserves each Register's ordinary visual and mechanical
identity while constraining its immediate subject and direction. The first
EMBODY opens from Quiet Equilibrium in the ancestral Home, establishing
ordinary intimacy before interruption. The first Crossing excludes fatality,
Maiming, and Tharn from its authored consequence range. Destruction, flight,
and four real Crossings bring every Founder to
maximum hidden Exposure without automatically creating Wound or Tharn. The
Reach 4 flash-forward gains meaning when the montage returns to it rather than
through an explanatory chronology label.

### Founding the permanent Home

Reach 5 realizes one of the selected Core Species' two founding-biome
relationships. Landscape Voice enters only after the final Crossing, when the
country becomes perceptible again. The founding MEET treats **Make Home** as an
explicit state transition.

The Founder who received Focus during the decisive Chaos Round appears as the
default first Leader, though the player may select another. One Founder must
sustain Leader before speaking for the group in the player's sole direct Colony
naming decision. The ancestral Colony's name remains visible while the player
assembles the new one from curated, species-influenced lists of words, sounds,
and forms through approved patterns. Ground, hope, and memory shape suggestions
without restricting their possible meaning. Confirmation makes the complete
name permanent and records it as part of Founding.

### Early Colony development

Rabbit and Squirrel begin with three Founders; Mouse begins with four. Every
Founder arrives at Exposure 6, then recovers to 3 at the first DAWN and 0 at
the second. The territory has no completed Residence or Practice. A fixed
reserve supports the initial three-Body-Unit recovery and contains material for
...
civic scale as the other openings before ordinary construction begins. This
specific welcome grants no automatic rule for later Wanderers.

DWELL introduces Civic Balance by showing three Body Units of Housing Pressure.
The tutorial guides one Rabbit or Squirrel—or suggests two Mice—into Builder,
then establishes the first Workshop through its sole bootstrap exemption. Place
designation costs nothing; the Practice requires the Project. One Mouse remains
a legal Builder but contributes one-half Civic Share-Day, so the same Project
takes twice as long as with two Mice or one full-share Builder.

Workshop completion opens ordinary Project capacity and the first strategic
choice: a Residence answers Housing Pressure, while a Garden enables passive
Sustenance. A Well-Placed first Residence houses all three opening Body Units;
a Not-Well-Placed one leaves one Body Unit uncovered. The unchosen need remains
visible until answered.

### The first expeditions

The Home Median may contain Sustenance and minor Scrap Nodes. The first Node
encountered there may be uncontested Sustenance; the first Node encountered in
a Margin is Contested. At least one Guest species appears within the first four
post-founding MEETs, introducing the wider animal community without requiring
immediate adoption.

The first Launch uses the ordinary legal party, visible Items, departure facts,
and Home subtraction preview without revealing an unseen Node or prescribing a
solution. The player chooses whether to explore the Home Median or cross toward
a Margin, when to turn back, and what returns. The first full Homecoming
recognizes the named travelers, reconciles all material and personal facts,
advances its ordinary Day Band, restores eligible Civic Shares, writes the
established history, and releases the campaign into open play.

## 6.3 Civic progression

Colony Tiers recognize a stable scale already reached and give it a shared
historical name. Tier number is common mechanical vocabulary; each Core Species
expresses that scale through its own civic form.
...
Population is the sole eligibility gate. Every living named Citizen contributes
their Body Unit regardless of age, health, availability, or current location.
Tier II recognizes a Colony able to prepare beyond its next immediate need;
Tier III recognizes a mature, durable Home able to endure and choose; Tier IV
is optional grand ambition.

Recognition additionally requires Quiet Equilibrium, an available Home-present
Citizen sustaining Leader, and a large escalating **Civic Dedication** outside
protected reserves. Committing it consumes its resources and one Day Band and
opens the Recognition MEET. The material becomes species-specific built fabric
rather than a Place, Practice, inventory object, numerical Capacity, or Project
Queue entry. Exact recipes belong to the dedicated economy-tuning phase.

The player may defer an eligible recognition indefinitely. The active Leader
conducts the ceremony, with universal Focus rules resolving any equally
eligible clash. Recognition proceeds one Tier at a time, enters Campaign
Memory, and remains historical truth through later contraction, Pressure, or
damage. Appendix D provides the complete Tier and Recognition reference.

## 6.4 Corridor progression

Corridor progression is the continuous world the Colony has reached,
experienced, and made practically accessible. Reaches and Margins exist from
...
becoming a network score or separate progression system.

Progress appears as revisitable change: a relationship alters a formerly
Contested Node, a resource site recovers or depletes, shelter becomes reliable,
a Guest or settlement recognizes the party, or a distant place enters ordinary
range. The map and Almanac present those established facts directly.

Social access remains particular to the involved animals, venues, and
relationships rather than becoming universal reputation. Colony scale and
Corridor ambition remain independent: a small Colony may travel far when it can
bear the domestic subtraction and risk, while a large Colony may remain close
to Home. Corridor development continues after any Tier plateau. Civic
Dedication gives recovered material a major Home use without making exploration
...
MEDIAN presents one persistent world through five Registers. Each changes what
the player attends to and how they act while preserving the same Citizens,
Places, objects, time, and consequences. The world remains visually primary;
the interface makes known facts, meaningful uncertainty, available actions,
and the consequences of commitment legible within it.

### Shared interface grammar

- Inspection, navigation, and provisional selection pause time.
- A discrete commitment identifies its immediate cost and affected subjects
  before it advances time or exposes them to consequence. Direct TRAVEL
  movement instead makes its accumulating distance and next Day-Band boundary
  continuously legible.
- Information appears beside the Citizen, Place, Node, Item, or situation it
  concerns where practical; broader detail remains available through
  inspection.
- Resolution stays in the present scene, and changed facts show what happened
  and why without detached reward screens or success grades.
- Register transitions preserve visual, spatial, and historical continuity.

Selection is reversible inspection; **Commit** changes the world. The player
may revise a provisional selection while time is paused. Commit uses one clear
grammar across Registers and avoids a second confirmation when the action and
its consequence are already unmistakable. Multiple-Round MEETs retain the
scene while updating its facts, stakes, and responses.

### Visible and private state

Actionable Colony facts—including Civic Shares, Role Load, Readiness, Role
Balance, Housing Balance, and known Telegraphs—remain legible. Colony Pressure
and Exposure remain private calculations, expressed through known causes,
Telegraphs, rest need, Wound, Tharn, and other experienced consequences.
Fractional production and Project contributions accumulate unseen until whole
results are awarded at DAWN.

The Record remains a hidden factual back end. The Almanac, Chronicle, Tales,
Citizen views, maps, and canon images present appropriate selections from
established state. The Community Board mirrors selected Almanac information
inside DWELL without gating access to it.

Interfaces show possibilities relevant to the actual task. Launch presents
only mechanically eligible Citizens; Core Citizens never present refusal or
personality approval because they are fractional player characters. Ordinary
MEETs show their authored responses. A relevant unavailable response remains
visible only when its absence matters, with a concise explanation based on
known facts; irrelevant responses are absent. Contested Away MEETs always show
**CONTEST → EVADE → PARLEY → YIELD → WITHDRAW** in that order, greying an
inactive family in place. Provisional response selection exposes only the
Tools, Supplies, Keepsakes, relationships, and Signatures that can affect it.
Focus resolves after Commit, randomly among equally qualified Citizens.
...
Selection, Place designation, construction, Project commitment, and Role
assignment occur directly through the Colony. Close views reveal particular
lives without leaving collective stewardship. Mouse preserves the feeling of
...
TRAVEL is a top-down, direct-drive overworld view. Directional input moves one
animated party figure—composed from the named Citizens present—through a
continuous Field while terrain, Nodes, shelter, Carry, bodily state, rest need,
and the remaining span of the Day Band stay readable around it. A stable
camera, limited paused panning, and modest zoom preserve both animal scale and
terrain legibility.

Actual path length, terrain, conditions, and burden consume the current travel
span; Rabbit's multiplier extends it. A Node becomes distinct before
engagement opens MEET. A Roadway occupies the approaching edge before its
...
Staging Post view across the Roadway. The backplate carries place, weather,
traffic, River Spume, danger, and far-side refuge; the normalized schematic
carries planning information and the complete proposed passage.

- Rabbit reads the broad traffic pattern, an opening, the party's complete
  line, and the selected refuge.
- Mouse links three to six pavement-scale, body-credible points into one
  continuous scurry.
- Squirrel reads flowing traffic geometry through one or two redirects and a
  far-side anchor.

Land-bound Guests remain within the Core Species grammar, constrained by their
...
MEET is a presentational scene-and-matrix composition backplated by its actual
Node, part of Home, Staging Post, or other owning Place. The player-aligned
subject appears on the left; the answering animal, condition, opportunity, or
threat appears on the right. This **antagonist** is a dramatic position, not a
requirement for hostility or personhood.

A concise subject and one to three stakes frame a stable choice band.
Provisional selection expands a response in place to show applicable objects,
...
Paused Registers provide contextual inspection and the principal information
lenses without losing camera, selection, location, or provisional choice:

- **Almanac:** current known state, Telegraphs, schedules, forecasts, and
  meaningful uncertainty
- **Map:** known geography, party position, projected reach, discovered Nodes,
  Outposts, shelter, and world changes
- **Roster and Citizen view:** belonging, location, availability, body, Role,
  relationships, possessions, current canon image, and Tale
- **Chronicle and Tales:** player-facing Campaign Memory selections

Visible persistent subjects open their appropriate contextual view directly.
MEET permits inspection of known participants and capabilities before Commit;
full reference closes during a committed Continuous Run and returns at its
resolution. Each authoritative fact receives one functional presentation
rather than parallel ledgers.

Home and Away are operationally exclusive and informationally permeable.
Launch transfers operation from DWELL to the one active expedition; Homecoming
restores ordinary DWELL. While Away, Home views permit inspection but not
construction, Role assignment, Project commitment, or another Launch. The
Colony continues through its established civic state, while the party never
moves, rests, interacts, or decides autonomously when attention is elsewhere.
DAWN reports completed Colony accounting before returning to the party. A
consequential Home MEET may temporarily take focus and then return operation to
the party's persistent Field position.

### Controls and accessibility

Every action is fully remappable across keyboard, mouse, controller, and
equivalent directional input. Inspection, planning, selection, and decisions
remain untimed. RISK planning can pause or advance observed traffic in readable
steps, while the Continuous Run requires no reaction input. DWELL camera
movement does not require simultaneous precision input; EMBODY uses bounded
controls and permits departure without penalty.

Text scaling, contrast, captions, interface density, camera motion, shake,
flashing, and transition intensity are adjustable. Important information uses
text, shape, position, and icon as well as color. Accessibility changes
presentation and input demands while preserving the same world state and
authored decisions.
...
root, bark, mud, and rain meet asphalt, concrete, salt, rust, rubber, plastic,
drainage metal, and reflected road light. Animal civilization grows within
those materials through scavenging, craft, spatial knowledge, and collective
use.

Home is warm, inhabited, and gently storybook; the Field makes the same
animals small within a colder, less accommodating world. Scale, weather,
sound, obscured visibility, and sudden motion give danger weight while the game
retains color, tenderness, humor, and ordinary civic life. Each Register
expresses this contrast through the presentation defined in Section 7.1.
Night preserves the highway's material identity through headlight wash,
brake-light red, reflective signs, wet asphalt, distant windows, and uneven
darkness.

### Strategic transparency and bodies

All Core Colonies remain visibly operable above ground. The camera may fade a
roof, omit a near wall, thin foliage, or clarify an overlap so rooms, paths,
Citizens, and civic relationships can be read. This **strategic transparency**
belongs to presentation: open to the player does not mean exposed within the
world.

Citizens are fully anthropomorphic characters with recognizable animal bodies.
They speak, build, remember, and form communities, while locomotion, scale,
posture, and capability remain species-grounded. They may stand, grasp, carry,
and gesture as their bodies permit; Crossings place grounded animals on four
feet while Flyers use their parallel expression. Ears, head, stance, gait,
stillness, and relation to others lead expression, supported rather than
replaced by the face.

### Material culture and visual continuity

Natural matter and corridor debris become animal-scale material culture:
bark, shell, grass, roots, leaves, cloth, paper, rubber, plastic, wire, caps,
and fragments are selected and remade. Clothing is selective. Wraps, cloaks,
belts, pouches, weather coverings, and adaptive devices can distinguish and
protect without obscuring fur, feathers, markings, posture, or Keepsakes. Role
...
Roster, MEET, EMBODY, aftermath, transition, Chronicle, and Citizen panels.
Lasting change updates the current image; earlier images remain in secondary
history. A small current Colony image set establishes spatial form and life,
while superseded views preserve meaningful stages of growth, damage, repair,
season, and occasion. Generated setups may change composition, light, posture,
and participants, but must use the relevant canon imagery and preserve current
facts. Appendix C defines the complete reference-and-amend method.

### Animal scale, weather, and sound

Human infrastructure retains its full magnitude. Lane paint, barrier seams,
bolts, tires, grates, culverts, vehicles, signs, and machinery anchor scale and
become terrain, shelter, obstruction, resource, or danger. Giants remain
outside the frame; their world is known through traffic, maintenance, Road
Work, litter, runoff, noise, light, and disturbance. Vehicles and machinery
may appear in full. Force is conveyed through magnitude, speed, air, vibration,
sound, obscured sight, aftermath, and animal reaction rather than explicit
injury spectacle.

Persistent geography changes meaning by Register and state. A culvert may be
terrain, shelter, Node, flood obstruction, or Outpost entrance; a wreck may be
orientation, salvage, or a MEET backplate. Light, Day Band, weather, and season
change the readable condition of the same place. Growth and dieback, water,
wear, repair, ground condition, stored matter, and civic adaptation accumulate
as its material history. Mechanically relevant conditions use aligned motion,
shape, texture, sound, text, and icon rather than a decorative filter.

Sound makes the Corridor readable. Traffic has direction, density, rhythm,
mixture, approach, and mass; River Spume makes its displaced air and debris
visible. Home layers species movement, conversation, work, teaching, weather
against shelter, road noise, and Guest vocal presence. Quiet Equilibrium lets
ordinary civic detail emerge. Field sound opens outward into vegetation,
water, insects, animals, drainage, and human activity; RISK brings traffic
close enough to read gaps and vehicle type by ear. Every important audio cue
has an aligned visual form.

Individual sound remains bodily: footfall, breath, fur or feathers against
material, carried objects, calls, and adaptive devices distinguish species and
Citizens. Maiming changes movement sound consistently and respectfully. Tharn
abruptly narrows the wider field around breath, pulse, fixation, and peril.

Landscape Voice is a distinct human narration of country, weather, movement,
and simple events, separate from animal speech, cultural expression, and
mechanical notification. Music is sparse and adaptive, supporting transitions,
Homecoming, ceremony, wonder, or grief before receding so the place itself can
be heard. It follows what has become perceptible, preserving the shock of
concealed danger.

## 7.3 Content-authoring doctrine

The Authorial Grammar governs terminology, capitalization, semantic
typography, and specification prose. This doctrine governs how an established
...
Begin with state already held by the world, Colony, Place, Node, Citizen,
party, object, relationship, or clock. Give it concrete geography, bodies,
material, time, and circumstances; derive choices from credible affordances;
and return the outcome to its established owner. A bounded authored exception
may express a particular species, Guest, Place, object, or event. A new
universal mechanic requires an explicit design decision.

### Constructing a MEET

Chapter 1.5 owns the shared form. A content author:

1. Names the owning system and facts that make the MEET eligible.
2. States its subject in one concrete sentence.
3. Establishes Place or Node, Day Band, conditions, participants, and known
   uncertainty.
4. Selects one to three present stakes.
5. Authors materially different responses and their availability; contested
   Away MEETs retain the five canonical families and order.
6. Attaches each relevant object, relationship, Signature, or civic commitment
   to the exact response it can express and states what it changes.
7. Resolves shared results before assigning bodily, personal, material, and
   relational consequences through causal involvement.
8. Returns changed facts to their owners and identifies any credible
   continuation or Campaign Memory expression.

An ordinary decision offers at least two meaningfully different courses. A
state transition instead earns its MEET by reconciling several persistent
facts. Multiple Rounds arise when commitment changes but does not close the
situation. The **particularity test** asks whether the content would remain
substantially unchanged with another species, place, time, or condition; a
strong MEET makes at least one of those facts matter to response, cost, or
consequence.

### Names and animal language

Names translate a community's relationship with its world through concrete
animal-scale perceptions of material, enclosure, openness, height, route,
sound, weather, use, and history. Shared Practices keep their functional
names; proper names belong to particular Colonies, Reaches, Nodes, landmarks,
and remembered places. Curated banks provide speakable components rather than
procedural laws.

Mouse tends to notice edges, interiors, joins, and shelter; Rabbit shared
ground, breadth, neighborhood, and gathering; Squirrel height, anchors, lines,
direction, and reach. These are tendencies, not exclusive vocabularies.
Species voice likewise changes attention and comparison rather than facts,
intelligence, accent, or rigid syntax. Chronicle, Tales, dialogue, and scenes
may express the same world through those cultural perceptions. Familiar human
objects acquire ordinary shared terms; the animals do not rediscover fences,
drains, vehicles, and structures on each appearance.

Every individual Citizen receives a curated Given Name; a rarer After-name
arises from durable history. Collective Citizen forms use their approved
household names. Guest headings and rules use canonical short species names,
with longer established forms available in prose. Hyphen-bound forms mark only
deliberate animal-language concepts whose translation requires several English
elements. Appendix B supplies the full language and naming reference.

### Narrative throughout the Concept Sourcebook

Narrative makes time, relationship, particularity, decision, consequence, or
remembered change legible beside authoritative specification:

1. **Sustained narrative** carries a sequence that depends on continuity,
   especially the Founding Escape and potentially one continuous expedition.
2. **Recurring lived moments** revisit established Citizens, Places, objects,
   and relationships so familiarity can accumulate.
3. **Worked play sequences** follow concrete state through judgment,
   resolution, and persistent change.
4. **Literal game presentations** reproduce forms such as Chronicle, Tale,
   Almanac, MEET, RISK, and Community Board when the form itself is taught.
5. **Narrative-bearing art and environment** use Landscape Voice, captions,
   recurring geography, visual continuity, and established physical detail.

Part openings choose the form appropriate to their transition rather than one
formula. A full plate may carry one or two sentences of Landscape Voice; an
opening may instead use sustained narrative, a recurring Citizen, a literal
game presentation, or silence. Narrative sits beside the system it clarifies.
Tables, diagrams, and infographics carry fixed relationships; narrative earns
space through bodily scale, uncertainty, sequence, recognition, relationship,
departure, return, or accumulated history.

Ordinary work, proximity, care, hospitality, rest, observation, disagreement,
and routine establish what danger can change. Rabbit's prominence in the
Founding Escape is balanced by strong Mouse and Squirrel presence across the
book. The Augments Phase will assign narrative, artwork, diagrams, and game
presentations page by page using briefs that state governing section, function,
participants, place and time, incoming and outgoing state, and reason for
inclusion.

### Canon and precision

The GDD states positive canon: what exists, what the player does, which rule
applies, and what consequence persists. Intros establish purpose and
experience before qualifications. Removed mechanics disappear from active
specification; their history belongs to provenance.

Examples make rules concrete but bind only the propositions explicitly adopted
in canonical prose. Concept images and sample passages remain illustrative
until authorial review states an adopted proposition in its owning section.

Numbers appear when they create a legible decision, preserve a meaningful
ratio, or give a bounded system necessary exactness. Stable player-reasonable
relationships may use formulas; qualitative states carry differences that do
not benefit from arithmetic. Whole units, short ranges, and memorable
fractions predominate. Examples use the least precision needed, and unsettled
costs, chances, durations, or thresholds remain identified as tuning.

Where useful, local prose distinguishes:

| State | Meaning |
|---|---|
| **Canonical** | Approved v0.5 design in its owning section. |
| **Provisional** | Approved direction with identified detail still subject to a later pass. |
| **Tuning** | Quantity or balance to test without reopening the system's purpose. |
| **Open** | Unresolved design awaiting authorial judgment. |

These states create no second registry or lifecycle. An open matter remains
open; a quiet gap implies no mechanic.

### Landscape Orientation

**Landscape Orientation** turns a physical location into MEDIAN terrain,
composition, narration, and situated play:

1. Establish governing specification and world state.
2. Construct an exact cross-section: grade, material, vegetation, drainage,
   light, weather, sound, visibility, and human infrastructure.
3. Choose an animal-scale observation point.
4. Determine what is visible, concealed, reachable, useful, dangerous,
   familiar, and unknown from there.
5. Read those facts through the bodies, species, purposes, and histories
   present.
6. Derive candidate movement, choices, situations, images, and Landscape Voice.
7. Check each against its governing specification and obtain authority for any
   addition or exception.

One physical world supports several bodily readings. Terrain shapes
perception, choice, movement, and consequence. Art and prose may reveal
candidate affordances, but remain illustrative until accepted; established
systems and persistent state retain authority.

## 7.4 v0.5 scope and explicit deferrals

MEDIAN v0.5.0 is a Concept Sourcebook for a theoretical game. It establishes
the attachment-forward proposition; one persistent Home-and-Away world; five
Registers; Corridor, Colony, Citizen, expedition, decision, progression,
memory, interface, art, sound, and authoring systems; and the relationships
that make them one coherent work. It is complete as a concept that can be
imagined, examined, and developed further, not as a software-production plan.

### Dedicated Items and Resources tuning phase

A later conceptual pass will tune acquisition, Carry, Jostle, expedition
duration and drain, production, preservation, consumption, construction, and
other recurring costs as one economy. It will set the material and Civic
Share-Day requirements for Places, improvements, Tools, Supplies, Outposts,
restoration, and Civic Dedications against the expeditions and domestic
opportunity costs needed to provide them. It will test Core-Species Carry and
travel differences while preserving civic parity and resolve provisional
Supply-class names. Quantities change; adopted system relationships remain.

Other bounded tuning includes population and maturation timing, housing
multipliers, World Pressure cadence and Telegraphs, season and weather timing,
traffic thresholds, Node renewal, and marked chances, ranges, durations, or
frequencies.

### Later content and work
...
full plates across the unified book without reopening the systems they explain.
**Family** remains provisional terminology for the relationship in Section
3.7; other explicitly open questions remain open in their owning sections.

The desktop and console computer game is the primary full-spectrum
manifestation. Tabletop roleplaying, cooperative fixed-content card, and
standalone mobile forms are translations that may receive their own concept
books. Later-version ideas remain evidence for future work until explicitly
brought into scope.
...
The game holds one persistent world across Home and Away. DWELL builds and
...
population, Carry, TRAVEL, RISK, Residence, and spatial expression give each
campaign a different character. Guests remain full Citizens with their own
bodies, residences, routines, and bounded Signatures.
...
MEET gathers the actual place, participants, known facts, stakes, and responses
through one shared decision grammar. Tools, Supplies, Keepsakes, relationships,
Guest Signatures, and civic commitments express those responses. Focus follows
one life while resolution remains collective and consequences return to the
systems and Citizens that own them.

Campaign Memory preserves what the Colony becomes. Its hidden Record holds
factual history; Chronicle and Tales select and translate it; canon images
preserve the changing visual truth of Citizens and Home. The Almanac presents
current state and known possibility. Building, departure, consequence, return,
and remembrance deepen one another.
...
Each Appendix and third-level section displays the MSID of the MEDIAN property
it principally defines, elaborates, or translates. Where a section necessarily
joins properties, it displays the smallest sufficient set. Fourth-level
subsections inherit the nearest displayed MSID unless they introduce a
different property explicitly. Appendix letters, page structures, worked
campaigns, manifestations, and comparative categories do not receive MSIDs of
their own.

## Appendix A — Lexicon and Canonical Usage

`Architecture.SemanticLanguage`
...
`Narrative.Naming` · `Narrative.Expression`
...
`Home.Colony.Name` · `Narrative.Naming.PlaceName`
...
`Narrative.Recognition.AfterName`
...
`Narrative.Expression.AnimalLanguage`
...
`Narrative.Expression.AnimalVoice`
...
`Narrative.Expression.OralCulture`

MEDIAN's animals carry remembered language about living together inside The
Highway. **Laws** give culturally durable form to truths the animals have
learned about the world. **Sayings** hold observation, value, warning, humor,
and memory without acquiring an instructional duty.

#### Current v0.5 standing

The Laws and Sayings below are canonical cultural material, but their present
place in v0.5 is tangential and non-binding. Their relationship to the game is
interpretive: they can describe or illuminate systems whose actual rules live
...
#### Deep Laws and cultural expression

A **Deep Law** is the stable truth beneath its in-world expressions. The
reference names and invariant statements below keep the three versions aligned;
animals need not speak the editorial phrase *Deep Law*. The quoted forms are
the present expressions associated with Rushbottom, New Elderbank, and
Morningside. They demonstrate Mouse JOIN, Rabbit GATHER, and Squirrel CONNECT
without creating different mechanics for the three civilizations.

| Deep Law | Stable truth | Rushbottom — Mouse / JOIN | New Elderbank — Rabbit / GATHER | Morningside — Squirrel / CONNECT |
|---|---|---|---|---|
...
exhaustive phrase bank for every Colony. Another Core civilization may carry a
different authored expression of the same Deep Law. Guests may interpret,
translate, dispute, misunderstand, or reframe one for character and humor; the
stable truth and the owning mechanics remain unchanged.

#### Collected Sayings

The current shared pool favors concrete observations over statements of design
principle. The resonance column records why each Saying belongs in MEDIAN's
cultural language; it grants no mechanical effect.

| Saying | Cultural resonance |
|---|---|
| *“Every life has a name.”* | Particular lives remain recognizable within collective civic life. |
| *“The road is never gone. It is only set far off.”* | Home is relative sanctuary within an active Highway environment. |
| *“The road gives what it throws away. The wall gives what it keeps.”* | Roadway and Sound Wall shape different material and ecological opportunities. |
| *“Far ground, thin cover.”* | Distance from shelter changes how exposed the world feels. |
| *“Most come home. Not all come home whole.”* | Departure carries credible consequence without making loss constant. |
| *“The mending is not the making.”* | Repair, recovery, and adaptation preserve the history of what changed. |

Laws and Sayings may appear as animal dialogue, remembered instruction,
Chronicle or Tale language, an inscription, or a Sourcebook epigraph when an
authored presentation calls for them. Those are expressive uses rather than
automatic tutorial prompts or required interface surfaces. Landscape Voice may
report that animals speak or remember this language, but remains a human
narrator rather than the source of animal oral culture.

### Landscape Voice

`Narrative.Expression.LandscapeVoice`
...
`Narrative.Naming.ComponentBank`
...
### Campaign Memory reference

`Narrative.Memory.Reference`
...
`Narrative.Presentation.MomentBrief`
...
`Narrative.Presentation.WrittenRealization`
...
`Narrative.Presentation.CanonImage`
...
`Narrative.Presentation.CanonImage.Amendment`
...
`Narrative.Presentation.MomentComposition`
...
`Narrative.Presentation.Image.Validation`
...
`Narrative.Presentation.Delivery`
...
`Home.Colony.SpatialAlignment` · `Home.Colony.Residence`
...
Placement also shapes access, adjacency, circulation, exposure, resilience,
and the physical geometry through which failure can occur. These situated facts
inform authored Home situations without creating another species-specific
civic meter.

### Civic Balance

`Home.Colony.CivicBalance`
...
Role shortfalls rank by absolute uncovered Load; the greatest relevant
shortfall normally supplies a situation's primary civic stake, while another
actual shortfall or situated fact supplies its collateral stake.
Pressure creates vulnerability and MEET context rather than automatic daily
damage.

Home recalculates this direction at DAWN, a materially relevant Day-Band
transition, the beginning or end of a forecast event, a special-event trigger,
or another meaningful state change. Recently used deficiencies, situation
families, Roles, Places, and threatened values are weighted down so persistent
Pressure can deepen without producing the same MEET every day. When several
Role shortfalls are equally deep, the actual physical circumstances resolve
which leads. Prominent Housing Pressure locates the situation in the affected
Residence and Citizens.

One ordinary shortfall is never charged simultaneously through automatic daily
decay, increased situation frequency, worsened choices, and redundant repair.
Pressure selects and shapes situated consequence; resolution applies that
consequence once, and a Project follows only when a persistent result genuinely
remains unfinished.

### Practice Strength

`Home.Colony.PracticeStrength`
...
Builder owns the physical soundness and deliberate transformation of Home.
Workshop is Builder's principal Practice, but it remains shared with Crafter;
other Practices may create structural obligations or receive Builder Projects
without becoming Builder Practices. Covered Builder Load includes ordinary
corrections to coverings, lashings, retaining earth, protected openings,
drainage, access, route anchors, passages, and connections. Adequate Readiness
keeps this inhabited fabric sound without turning each part of Home into a
separate repair order.

The Colony may undertake the Project establishing its first Workshop without
an existing Workshop. This sole bootstrap permission still requires material,
time, and committed Builder Citizens; the unfinished Workshop supplies no
Practice Strength, and completion ends the permission. Every later Workshop is
established under the ordinary Project rules. A completed Workshop retains its
situated support while hosting a Project, recalculated from whatever compatible
ordinary Role support remains, but no Workshop advances a Project without
committed Citizens.

Builder Projects establish Residences and Practices at designated Places;
reinforce shelter, access, drainage, routes, or anchors; restore persistent
structural damage; construct or restore Outposts; and complete major physical
or Tier-defining work. The receiving Residence or Practice remains the subject
of the change rather than acquiring a second Builder facility. Committed
Builder shares leave ordinary Builder Readiness while the Project proceeds.

Builder shortfall creates vulnerability to wind, flooding or failed drainage,
softened or frost-heaved ground, damaged coverings or anchors, broken access,
structural overextension, and persistent damage. MEET situates consequence in
actual inhabited ground. Immediate resolution normally completes the
transaction; a restoration Project follows only when a persistent physical
result remains unfinished. Builder supplies neither passive construction nor a
generic Project-speed or durability bonus. Tool-making belongs to Crafter.
Guest Signatures may reveal a structural circumstance or improve a response,
but they neither replace Builder responsibility nor perform Projects without
Citizens.

#### Gardener

Gardener owns cultivation, seasonal yield, and the continuing health of
cultivated ground. Garden is Gardener's Practice. Builder ordinarily
establishes each Garden through a Builder Project after the first Workshop;
Garden has no bootstrap exemption. An unfinished Garden supplies neither
Practice Strength nor Sustenance. A usable Garden produces only through the
Garden-and-Gardener gate defined under Passive production and transformation.

Covered Gardener Load includes planting, tending, gathering, protecting
growth, maintaining soil, answering ordinary heat or rain, and preserving
cultivated continuity between yields. Coverage preserves Garden condition and
next-season readiness even when the season permits no ordinary production.
This work remains Colony-scale stewardship rather than per-plot staffing,
individual harvest orders, or simulated travel among Gardens.

Gardener Projects establish a cultivated line; restore persistently damaged
ground; adapt one Garden for Winter Cultivation; reshape a Garden for a newly
understood use; or make another lasting seasonal or ecological change. Routine
planting, tending, gathering, and green-season yield remain ordinary work.
Builder and Workshop support may establish or physically alter a Garden
without taking its continuing purpose from Gardener. Project-committed
Gardener shares leave both Readiness and ordinary yield.

Winter Cultivation is learned knowledge applied separately to each Garden by a
Gardener Project. An ordinary Garden produces no regular winter Sustenance; an
adapted Garden with sustaining Gardener coverage produces at one-quarter of
its normal eligible throughput, using the shared fractional accumulation rule.
Learning the method adapts no Garden automatically.

Suitable managed Nodes and Sustenance-bearing Outposts may provide bounded
situated additions or modifiers. They remain neither Practices nor substitutes
for the Garden-and-Gardener production gate.

Gardener shortfall creates vulnerability to drought, heat, washout, crop loss,
poor yield, damaged soil, lost cultivated continuity, and winter shortage.
MEET situates that vulnerability in an actual Garden, family, reserve, or
threatened part of Home. Passive output remains limited to defined Perishable
Sustenance. Guest Signatures may change cultivation circumstances or open a
lasting Garden Project, but they do not change Gardener coefficients or bypass
the production gate.

#### Crafter

Crafter owns the transformation of recovered material into functional civic
and Away capability. Workshop supports both Crafter and Builder without
becoming two Practices or requiring Citizens to be assigned to individual
Workshops. The first Workshop arrives through Builder's bootstrap permission,
so Crafter has none of its own. Each completed Workshop hosts at most one
active Project, whatever Role owns that Project's purpose.

Covered Crafter Load includes sorting recovered matter, maintaining shared
...
Tools are deliberate, durable Away-function Items. Making one requires a
Crafter Project, appropriate Scrap, time, a usable Workshop, and committed
Crafter Citizens. Ordinary maintenance and repair remain covered work;
restoration or adaptation becomes a Project only when it makes a new persistent
fact true. Other Crafter Projects may adapt a Workshop, establish a lasting
fabrication capability, create a defined civic artifact, or make components
for a larger persistent change. Physical collaboration never changes which
Role owns the Project's principal result.

Fine Work is established in one Workshop through a Crafter Project. It opens
Specialist Tools: individually defined, reproducible, one-slot personal Tools
whose specific authored capabilities lie beyond the five ordinary Tool
classes. Each known design has its own recipe and Project and may become known
through a Guest, the Rest-Stop Metropolis, or another direct world source. A
Specialist Tool remains distinct from a singular Special Artifact. Fine Work
adds no Supply throughput, Practice Strength, or Project capacity.

Crafter shortfall creates vulnerability to unavailable Supplies, Tool failure,
disordered or unusable material, failed substitution, and inability to answer
a situated material need. Consequence appears through MEET, an active Project,
a particular Tool, or the Place and need under pressure rather than automatic
daily material loss. Crafter supplies no generic Project-speed bonus or
industrial production line. Guest Signatures may expose material possibilities
or options, but they neither alter Crafter coefficients nor bypass recipes and
Projects.
...
Watchkeeper owns the singular civic responsibility of noticing pressure early
enough for deliberate response. Watchpost is its sole Practice, preserving
sightlines and listening lines, known approaches, warning markers, protected
observation, and communication into inhabited Home. Edges, high lines,
listening points, routes, and approaches remain physical circumstances of the
Practice. Basic watch is possible before a Watchpost exists, so Watchpost
requires no founding exemption.

Covered Watchkeeper Load includes Home's approaches and boundaries, flood
signs, changing water, human activity, predator movement, route obstruction,
weather Telegraph, and unusual sound, vibration, scent, or absence. Adequate
Readiness produces earlier, clearer, and better-localized Telegraph, may let
ordinary pressure be absorbed, and improves the circumstances in which a
consequential response begins. Warning remains qualitative and useful because
it supplies time or information, not because it guarantees prevention or
displays probabilities.

Watchkeeper Projects adapt Watchpost; extend warning to newly inhabited
ground; establish a lasting signal or communication line; restore a lost
warning connection; or adapt warning infrastructure to recurring pressure.
Focused observation, forecast preparation, and threat survey remain temporary
commitments unless they establish a persistent result. Builder or Crafter may
support the physical work without taking its warning purpose from Watchkeeper.

Far Warning is established in one Watchpost through a Watchkeeper Project. It
extends observation beyond Home's immediate approaches and may identify the
family of an eligible seasonal, environmental, animal, human, or route pressure
early enough to create another preparation window. It supplies no exact
probability, countdown, location, severity, or certainty; observes no
unobservable pressure; and adds no Readiness, Practice Strength, or Project
capacity.

Watchkeeper shortfall makes warning late, incomplete, or badly localized,
narrowing preparation or response before a threat reaches inhabited ground.
MEET situates consequence in the actual Place, route, Residence, Practice, or
Citizen at risk. Shortfall never permits catastrophic loss to occur unseen
while player attention is Away. Watchkeeper is neither combat class nor guard,
universal surveillance, exact prediction, or per-edge assignment. Resident
Signatures may provide distinctive warning or response without replacing
ordinary Watchkeeper responsibility.
...
shared expression in DWELL and may physically stand elsewhere in Home without
designating another Place. The Almanac remains always available. Community
Board detects, forecasts, improves, or decides nothing, gates no ordinary
...
Exact thresholds remain a tuning value rather than a player-facing optimization
problem.
...
Nesting becomes eligible only during a species-appropriate green-season window
and never begins automatically. Quiet Equilibrium creates civic room for a
proposal without causing one. At the first eligible DAWN after the intended
campaign interval, no more than one authored Nesting Proposal may arise from
particular mature, present Core Citizens selected through their relationships,
Tales, ages, and circumstances. The player never assigns prospective parents;
if no one is eligible, no proposal appears. An active or sufficiently recent
Nesting commitment suppresses another proposal for the intended interval.
...
Provisioning, unrelated Projects, and discretionary spending cannot use that
reserve.

The player may accept, defer within the window, or refuse. Deferral and refusal
enter the involved Citizens' history without an automatic relationship penalty.
Normally only one successful commitment resolves in a Colony-wide seasonal
window. Success adds a very small number of fully named young Citizens, who
...
Because spoilage resolves before new passive production, newly produced
Perishable Sustenance receives one full decision window before it becomes
eligible to spoil.
...
`Citizen.Item.Keepsake` · `Citizen.Item.SingularTrackedItem`
...
- Replacing a current Keepsake requires both a meaning-making event and player
  confirmation; ordinary equipment management cannot overwrite it.
...
`Citizen.Item.EncounterExpression`
...
`Away.Expedition.Carry.StrainedCarry`
...
`World.Highway.EnvironmentalBand`
...
`World.Event.RoadWork`

Road Work is an exceptional authored World event. It gives active human
maintenance a sustained physical footprint, a linked sequence of Colony
decisions, and a lasting result in the Corridor. It uses World Pressure,
DWELL, TRAVEL, RISK, MEET, Nodes, and persistent state rather than opening a
separate defense or repair mode.

Lane work, barrier replacement, resurfacing, mowing, drainage clearance,
culvert work, staged material, and machinery are authoring ingredients. They
derive their identity from the work that is physically occurring, the ground it
occupies, the forces it produces, and the particular lives and places exposed
to it rather than from a formal event family.

#### Episode contour

Road Work expresses the universal event arc through five concrete beats:

| Road Work beat | Shared phase | Function |
|---|---|---|
| **Telegraph** | Telegraph | Markings, equipment, changed traffic, cut vegetation, sound, vibration, light, or unusual scheduling makes the coming work partly legible. |
| **Onset** | Impact | Workers, vehicles, machinery, or barriers enter the footprint; access and traffic take their active states. |
| **Active Work** | Persistence | The work advances, relocates, repeats, or changes the ground. New situations may arise as its footprint or stakes change. |
| **Withdrawal** | End of Persistence | Human occupation recedes and access begins to reopen. The world retains everything physically changed. |
| **Aftermath** | Aftermath | The Colony and expeditions encounter the new drainage, shelter, obstruction, exposure, Nodes, Crossing conditions, or damaged ground. |

Human activity governs the work's duration and Withdrawal. The Colony can
prepare, protect, relocate, endure, and adapt; its choices determine what the
event costs and what survives rather than whether the work proceeds. A beat
opens MEET only when it presents a meaningful choice. Ambient warning,
mechanical advance, and the simple reopening of access may instead appear in
DWELL, TRAVEL, the Almanac, or a concise world-state report.

#### Road Work authoring brief

Every episode specifies:

- The concrete human work and the animal-scale forces it produces
- Its starting footprint, direction of advance, greatest expected footprint,
  and affected Margin side
- At least three contiguous affected Reaches, including the directly affected
  Reach and its immediate longitudinal neighbors
- What can be Telegraph, when it becomes knowable, and how Watchkeeping or a
  relevant Guest Signature may sharpen that knowledge
- The incoming traffic, River Spume, vegetation, drainage, access, Nodes,
  Places, Practices, and Crossing conditions
- Which access points are Closed, which remain Altered, and what could remain
  Changed afterward
- The primary and collateral Colony stakes and the Readiness, Practice
  Strength, resources, relationships, Keepsakes, or Signatures that can shape
  a response
- The fixed event beats and the state-dependent situations that may open
  between them
- The physical result intended by the human work and the conditional results
  created by animal preparation and choice
- The Withdrawal condition, immediate reopening of access, and facts that
  persist into the Record

This bounded brief authors one event. The same ingredients can support
materially different episodes when their ground, season, inhabitants, and
human work differ.

#### Footprint, access, and Crossing

A normal active footprint occupies one Margin side across a short run of at
least three contiguous Reaches. The directly affected Reach and both immediate
longitudinal neighbors therefore share the closure, so a party cannot evade
the episode by moving only one Reach. An episode may occupy a longer run or
advance along it, while closing an entire known Corridor remains an exceptional
authored circumstance rather than the default.

- Ordinary TRAVEL into the closed Margin being unavailable throughout the
  active footprint
- Nodes inside active work remaining inaccessible for ordinary activation
- A party already beyond the affected Roadway retaining its actual location
  and choosing whether to wait, use an available Outpost, travel
  longitudinally beyond the footprint, or address a specific Away situation
- Movement and extraction never occurring automatically on the party's behalf
- A Closed Staging Post preventing RISK Commitment until work withdraws or the
  party reaches an unaffected Crossing opportunity
- An Altered Staging Post opening ordinary RISK with redirected traffic, work
  vehicles, lane compression, machinery, noise, dust, light, temporary
  materials, River Spume, sightlines, and refuge represented in the plan
- A Continuous Run already begun always reaching the far side before any new
  Road Work condition or penalty resolves
- Return Crossing using the same Closed or Altered state, with sufficiently
  consequential active conditions able to require Full RISK

After Withdrawal, access reopens wherever its physical basis has returned.
Repaired barriers, cleared verges, altered drains, resurfaced edges, new
obstructions, or changed refuge remain part of later TRAVEL and RISK.

#### Civic Balance and Colony attention

Road Work cannot be absorbed by Civic Balance. Full Role coverage, strong
Practices, reserves, and preparation give the Colony better ways to respond;
they never prevent the authored human event or reduce all of its consequences
to an ordinary DWELL report.

While active, Road Work supplies the primary substance of Colony MEETs. It may
open consequential situations at Onset, when work advances or shifts, when a
new Place or Citizen becomes exposed, and when Withdrawal presents a final
choice. This cadence may be denser than ordinary Home Pressure.

- Ordinary situation candidates waiting while the Road Work thread remains
  active
- Homecoming, an urgent independent situation, or another necessary
  state-transition MEET remaining able to interrupt it
- Normal repetition damping not suppressing the larger episode, while each
  successive MEET must change the phase, physical state, participants, or stake
  rather than restating the previous decision
- Readiness and situated Practice Strength determining which responses are
  available, how much they require, and what they can protect
- Watchkeeping and relevant Guest Signatures improving Telegraph without
  cancelling Onset
- Active Road Work preventing Quiet Equilibrium; EMBODY becoming available
  again only after Withdrawal and resolution of the immediate Colony demands
- A consequential Road Work MEET able to take active focus while an expedition
  remains Away, with the party and its world position persisting until the
  Home situation resolves

Road Work choices protect and adapt concrete stakes. They do not create a
generic durability payment, shorten human activity through Colony effort, or
require a repair Project merely because the event occurred. A Project enters
the Queue only when the outcome leaves a defined persistent result that a Role
can build, restore, or adapt.

#### Persistent transformation

Road Work can alter the world as deeply as its depicted activity warrants.

- Vegetation removal able to expose a Place, eliminate cover, alter a
  species-relative placement judgment, or change seasonal recovery
- Drainage work able to redirect water, dry one area, saturate another, reveal
  a cavity, or change the conditions supporting a Garden or shelter
- Barrier, verge, and surface work able to change sound, light, River Spume,
  sightlines, refuge, Staging Posts, and the physical line of a Crossing
- A Node disappearing when its actual physical basis is removed
- A disturbed Node transforming or recovering differently rather than simply
  resetting after a timer
- Excavation, displaced matter, or newly accessible structure revealing a new
  Node or animal-scale opportunity
- A Place becoming temporarily unusable or requiring an authored adaptation
  when the work reaches its ground

The Record preserves what occupied a changed site, what happened there, and
which Citizens were involved. That history does not preserve access to a Node
whose physical basis is gone.

#### The once-per-campaign Founding Escape recurrence

At most once per campaign, a Road Work episode may open a personal MEET in
which the sensory force of the work brings the Founding Escape back through the
body of one surviving Founder. Machinery, vibration, severed vegetation,
engine light, altered traffic, or collapsing ground must credibly connect the
present moment to that Citizen's established history.

- The Founder being alive, present at Home, and within sensory reach of the
  work when the event selects the situation
- The possibility remaining unannounced: the Almanac may Telegraph Road Work
  while never advertising this personal recurrence
- The MEET focusing one named Founder and the particular Place, relationship,
  responsibility, or Keepsake through which the moment is experienced
- That Citizen's contribution to the current Road Work response becoming
  unavailable for the present Round
- Responses able to commit a companion, bring the Founder to an available
  quieter Place or Hearth, or express an established relationship or familiar
  Keepsake as grounding
- Each response showing its immediate civic and personal cost without treating
  continued productivity as emotional recovery
- The moment creating no Fear track, Wound, diagnosis, or recurring Condition
- Resolution entering the Record and the Founder's Tale, with a later EMBODY
  opportunity possible after Quiet Equilibrium returns

Once recorded, no later Founder or Road Work episode can reopen the recurrence.
A campaign whose circumstances never support the event may never see it. Later
human disturbance can still recall established history in prose, Chronicle
selection, or a Tale without creating another mechanical recurrence.

#### Illustrative sequence — drainage clearance at New Elderbank

This sequence demonstrates the Road Work grammar through the continuing story
Colony. Its particular staging remains illustrative.

1. **Telegraph.** Orange marks, cut stems, staged pipe, and unfamiliar engine
   vibration appear along New Elderbank's southern Roadway. The footprint
   covers Ashcross and one neighboring Reach in each longitudinal direction.
   Watchkeeping clarifies that the south Margin and its nearest Staging Posts
   will close during the next active Day Band. The player receives a DWELL
   interval to rebalance civic work, secure exposed material, or move an Away
   party toward a different opportunity.
2. **Onset.** Machinery enters, traffic compresses, River Spume thickens, and
   the south Margin closes. Cleared drainage begins carrying water toward a
   Garden and the low edge of a Residence. A Home MEET asks whether the Colony
   commits available Builder and Gardener support to divert water from the
   Garden, commits available care and material to protect the Residence and
   its contents, or preserves ordinary civic work and accepts both local
   transformations. Human work proceeds under every response.
3. **Active Work.** Excavation removes the root mat supporting a known seed
   Node. That Node ceases to exist. The cleared ground also exposes a dry pipe
   mouth that may become a shelter Node after Withdrawal. An expedition already
   on the south Margin cannot use the nearest Closed Staging Post; it may wait,
   Stopover, or travel beyond the three-Reach footprint.
4. **Personal recurrence.** A change in the machinery's vibration and the
   collapse of cut ground bring Elderbank back to Twig. The current Road Work
   Round loses Twig's contribution and narrows into a personal MEET. Its
   available responses may draw upon Bramble's established bond, an available
   quiet Place or Hearth, and Twig's blue-tarp Keepsake. The choice determines
   who leaves the wider response, where Twig spends the moment, and what the
   Record retains; none erases the history. This consumes the campaign's sole
   Founding Escape recurrence.
5. **Withdrawal and Aftermath.** Machinery leaves and the south Margin reopens.
   Water now follows the cleared drain, the former seed Node remains absent,
   and the exposed pipe can be encountered as a changed place. The selected
   protections determine the Garden and Residence states. Any defined
   adaptation still required may enter the appropriate Project Queue; the work
   itself creates no compulsory generic repair.

#### Contrasting sequence — barrier repair

A shorter barrier-repair episode can center access and information rather than
direct structural damage. Staged panels close one Margin side across four
Reaches, compress traffic, strengthen River Spume pulses, and obscure a
Watchpost's familiar sightline. The active Colony MEET concerns relocating the
Watchkeeper's observation, protecting another exposed stake, or accepting a
temporary blind side. One Staging Post is Closed while another remains Altered.

After Withdrawal, the repaired barrier permanently seals a familiar gap while
creating a calmer lee and exposing material at its new end. The old Crossing
line and any Node based upon the former gap change accordingly; the sheltered
edge may support a different Node later. This uses the same Road Work grammar
without defining barrier repair as a separate mechanical family.
...
scheduling and content breadth, and broader event frequency remain assigned to
later authorial and conceptual tuning. Current design establishes their
relationships, causal inputs, persistent world effects, and points of contact
with Civic Balance and Citizen activity.
...
### Launch and Home subtraction

`Away.Expedition.Launch`
...
Only capabilities physically present with the party may shape the response. A
relationship requires a present participant or relevant known history. A
Keepsake may inform recognition without becoming the active Item; offering,
using, surrendering, or staking it makes it the Round's one active Item instead.
Using or risking any Item makes its carrier causally involved. A Guest
Signature remains bodily rather than an Item and may coexist with that Item
when both defined circumstances apply.

Aftermath returns every fact to its owning system. Spent Supplies remain spent;
Tool hazard remains resolved; gained or abandoned material changes current
Cargo; bodily and relational consequences remain with their bearers; and a
changed Node retains its actual new state without acquiring a generic
**cleared** or **completed** tag. Another Round opens only when the changed
situation still warrants one. Campaign Memory applies its own selection rules,
and Landscape Voice may accompany a resolution whose meaning depends upon
place.

### Exposure

`Citizen.Condition.Exposure`
...
`Citizen.Condition.Exposure.Recovery`
...
Those individual qualities shape dialogue, advice, routines, animation,
EMBODY, Focus, and contextual authored responses. Experienced events may
change them without converting personality into scores, trait tiers, or an
optimization taxonomy. Every population, Role, presence, and availability
total remains traceable to particular names.

### Core Species

`Citizen.Species.Core`
...
`Architecture.Scale.BodyUnit` · `Home.Colony.Residence`
...
`Citizen.Species.Core.AwayExpression`
...
Guest type is an authored part of a life rather than a player toggle, rarity,
or civic rank. An Expedition Guest may become Resident through an authored life
event, but routine reassignment never changes type.

#### Signature constraints

`Citizen.Species.Guest.Signature`

- **Attribution:** the responsible Citizen or collective-bodied household
  remains visible.
- **Situation:** the Signature operates only in its bounded circumstance or
  named Place relationship.
- **Restraint:** it opens or changes a choice or defined Place relationship
  without solving the whole situation.
- **Species grounding:** its possibility follows from the animal's body,
  senses, behavior, or ecology.
- **Suspension:** absence, injury, season, or Residence condition may make it
  unavailable when relevant.

An Expedition Guest's Signature operates Away; a Resident Guest's operates at
Home. It grants no general aptitude or extra action. Within MEET it may alter
the response matrix and may coexist with one applicable personal Item while
each retains its own authored effect.

#### Expedition Guest roster

`Citizen.Species.Guest.ExpeditionGuest`
...
`Citizen.Species.Guest.ResidentGuest`
...
`Citizen.Species.Guest.ExpeditionGuest.Profile`
...
`Citizen.Species.Guest.ResidentGuest.Profile`
...
`Citizen.Species.Guest.ResidenceException`
...
#### Hospitality, ordinary life, and continuity

`Citizen.Species.Guest.Hospitality`

1. The Colony meets a named animal in a situation with stakes independent of
   recruitment.
2. The outcome establishes recognition through relationship, obligation,
   promise, shared interest, or unresolved tension.
3. Terms of Hospitality state the complete Residence Fit and any explicit
   relational or safety promise required for continued life together.
4. A Builder completes or adapts the dedicated Residence—or the named
   Practice-sharing exception—through an ordinary Project.
5. When those Terms are true, Arrival adds the Guest to Home and the Roster.

The player may accept, delay, refuse, or fail to fulfill the Terms. One Guest
Residence houses one individual Citizen or collective-bodied household and
contributes no Core Housing Capacity. Later loss of Fit creates a visible
accommodation problem, may suspend a directly dependent Signature, and never
evicts the Citizen; repair or adaptation follows ordinary Project rules.

Role support remains Colony-wide. Launch removes an Expedition Guest's Civic
Share from Home, while injury, illness, season, displacement, or another actual
condition may make a Resident Guest unavailable. At Quiet Equilibrium, EMBODY
may accompany a bounded species activity or a characteristic state through
appropriate movement, senses, gesture, collective flow, or cinematic Presence.

Fireflies and Bumblebees are the complete collective-bodied set in v0.5. Each
household has one Roster entry, Residence, Role, Civic Share, Signature, and
continuous identity; several visible bodies never multiply output, Project
support, housing demand, or Signature use. Availability and consequence apply
to the household as a whole. Visible thinning, changed circulation, departure,
dissolution, or death becomes legible through an authored event rather than
background administration.

Injury, aging, relationship, or another authored life event may change how a
Guest participates without reducing civic standing. Departure and death alter
the living Roster while preserving relationships, memory, and a vacated
Residence as part of Colony history. Guest play remains optional: no rarity
tier, collection percentage, Tier, essential system, victory condition, or
recruit-all reward requires any Guest or completed roster.

### Species difference in ordinary life

`Citizen.Species.Expression`
...
### Story civilizations: three campaign histories

`Architecture.Cycle.HomeAwayReturn` · `Narrative.Memory`
...
without requiring one Colony to demonstrate every possible system. Complete
rosters preserve continuity; the prose foregrounds only the lives and events
that change each Colony's particular story.

| Story civilization | Core Species | Home Reach | Lost ancestral Home | Civic movement |
|---|---|---|---|---|
| **New Elderbank** | Rabbit | Ashcross | Elderbank | Inherited memory becomes shared and contested story |
| **Rushbottom** | Mouse | Pipe End | Chaff End | Exact names and records protect many small lives from anonymity |
| **Morningside** | Squirrel | Elmwater | Nine Beeches | Outward reach remains answerable to resilience and return |

Their Tier populations are story facts rather than universal growth schedules
or ceilings.

| Story civilization | Tier I | Tier II | Tier III | Tier IV |
|---|---:|---:|---:|---:|
| **New Elderbank** | 3 Citizens / 3 Body Units | 7 / 7 | 12 / 12 | 18 / 18 |
| **Rushbottom** | 6 Citizens / 3 Body Units | 12 / 7 | 20 / 12 | 30 / 18 |
| **Morningside** | 3 Citizens / 3 Body Units | 7 / 7 | 12 / 12 | 18 / 18 |

#### New Elderbank — Rabbit

New Elderbank carries the Sourcebook's sustained Rabbit history and the full
Founding Escape narrated in Part 0. Its Citizens inherit a name that looks
backward and gradually make that name refer to the Home they have actually
built.

| Recognition | Citizens first present by this Tier |
|---|---|
| **Close Commons** | Bramble; Twig; Shadepatch |
| **Open Commons** | Nutmeg; Daisy; Fennel; WHOOT |
| **Court** | Teasel; Yarrow; Moss; Rootwake; Burdock |
| **Grand Court** | Clover; Pebble; Slate; Bracken; Sable; The Lanterns |

##### Founding and Close Commons

Bramble, Twig, and Shadepatch leave the destruction of Elderbank, cross four
Reach-border roads, and reach Ashcross at maximum Exposure. Bramble receives
Focus during the Chaos MEET and appears as the default first Leader when the
party chooses to make Home. They name the Colony **New Elderbank**. Ashcross
retains the older name of the ground beneath it.

The first two DAWNs recover the Founders while their decisions establish the
Colony's Rabbit shape. Twig joins the first Builder commitment. Workshop,
Residence, and Garden gather around protected common ground, and the
Well-Placed Residence accommodates all three Founders. Shadepatch becomes the
most willing early expedition Citizen. Launch makes every absence legible in
Civic Balance; Homecoming begins turning those journeys into shared history.

An Owl appears during the first post-founding MEETs as a distant nocturnal
presence. Familiarity precedes welcome.
...
Daisy enters through a Nesting history and becomes family to Bramble and Twig.
Elderbank is inherited history to Daisy rather than personal loss. WHOOT is
eventually welcomed as a Resident Guest after the Colony provides a high
listening hollow. The Owl sustains Watchkeeper and sharpens eligible nocturnal
Telegraphs through Night Sky-watch.
...
Teasel, Yarrow, Moss, Rootwake, and Burdock bring the Colony to twelve Body
Units. Teasel continues Away participation after a forefoot Maiming. Yarrow
directs attention toward neglected ground already inside Home. Moss belongs to
a generation for whom the Founding Escape is established history.
...
make Pressure specific. At twelve Body Units, recognition names the mature and
durable Colony a **Court**.

##### Grand Court

Clover and Pebble join a Colony whose present Home matters more to them than
the ancestral one. Slate, Bracken, Sable, and the Lanterns broaden its
relationships to the Corridor through distinct Guest lives rather than a
collection of bonuses. The Lanterns become familiar across ordinary nights
before their Leader responsibility takes ceremonial importance.

At eighteen Body Units, New Elderbank waits for Quiet Equilibrium and commits
its Grand Court Civic Dedication. The Recognition MEET occurs at night with the
Lanterns as its focused Leader. Their procession makes the assembled Colony
legible while the dedicated material reshapes and dignifies the shared ground.

Bramble, Twig, and Sharpnose remain visible among Citizens who remember
Elderbank, Citizens who know it through competing stories, and Citizens for
whom New Elderbank is itself the ancestral Home. **New Elderbank** has ceased
to mean a diminished copy of somewhere lost. It names the particular place
these Citizens made together.

#### Rushbottom — Mouse

Rushbottom carries the Sourcebook's sustained Mouse history. Four Founders and
two immediate arrivals create the same opening three Body Units as the other
Core Species while beginning with six complete individual lives. Rushbottom
protects particularity through names and exact record while learning that a
careful count cannot make the world certain.

| Recognition | Citizens first present by this Tier |
|---|---|
| **First Rooms** | Barley; Thimble; Pip; Husk; Weft; Warp |
| **Joined House** | Tuck; Seam; Bran; Nook; Sump; Velvet |
| **Manor House** | Sheaf; Bodkin; Muslin; Crumb; Spool; Bobbin; Sedge; Rill |
| **Grand Manor** | Oat; Rye; Pleat; Fold; Lintel; Niche; Flax; Tow; Marl; Morrow |

##### Founding and First Rooms

Human drainage work approaches Chaff End over a season before the final
morning rupture. Barley, Thimble, Pip, and Husk are at a peripheral store when
the old Burrow fails. Barley receives Focus and becomes the first Leader.
Thimble turns flight into short intelligible handoffs. Pip goes back twice for
Citizens who never emerge. Husk keeps space open for whoever might still
follow.

The four Mice cross as two Body Units and reach the wet ground called Pipe End.
They name their Colony **Rushbottom** after the plants growing where runoff
collects: the mice name the plants; the Corridor names the concrete.

Immediately after Founding, a Home MEET introduces Weft and Warp, two
Wanderers already traveling together. Each enters as a complete Citizen with a
separate history and future. Their welcome brings Rushbottom to six Mice and
three Body Units before ordinary construction begins.

Thimble and Husk combine two half Civic Shares in the first Workshop Project.
The Residence adjoins it directly, and subsequent Places join the same
protected inhabited fabric without requiring passages between them. A
Well-Placed first Residence accommodates all six Citizens.

Rushbottom's smallest legal all-Mouse expedition contains three Mice: one and
one-half Body Units carrying eighteen secured slots. At the complete Body-Unit
scale, two Mice carry twelve secured slots where one Rabbit or Squirrel carries
ten. Every Mouse also retains a personal Tool, Supply position, Keepsake, and
exposure to consequence.

Barley counts because names must not disappear. Pip keeps looking because a
count can still be wrong. That tension begins before the First Rooms are
complete.

##### Joined House

Tuck and Seam enter through Rushbottom's first Nesting history. Bran earns
trust when a later expedition verifies the unfamiliar Reach previously
described. Nook arrives alone; because Weft and Warp came together, Rushbottom
searches for a second traveler before accepting that none exists.

Sump already inhabits Pipe End and becomes a Toad Citizen only after repeated
relationship and fulfilled hospitality. Velvet's Bat Residence is later
incorporated into the Workshop as a high dry-dark roost. Growth fills the first
Residence and extends Rushbottom through additional adjoining rooms.

At twelve named Citizens and seven Body Units, the Recognition MEET commits
joinery, partitions, reinforcement, furnishings, and accumulated detail
throughout Home. Rushbottom becomes a **Joined House**.

##### Manor House

Sheaf and Bodkin, Muslin and Crumb, and Spool and Bobbin enter as three pairs
of littermates whose individual lives quickly diverge. Sedge brings Snake
Display into eligible SPEAK situations. Rill brings Weasel Drive Off and a
predator's body into particular civic relationship with the Mouse Colony.
...
attachment obligation as well as an advantage.

At twenty Citizens and twelve Body Units, the Colony's joined architecture
remains visibly readable in DWELL. Recognition names it a **Manor House**.

##### Grand Manor

Oat and Rye, Pleat and Fold, Lintel and Niche, and Flax and Tow add eight
different lives through four later Mouse pairs. Marl makes hidden ground
legible through Mole Subsurface Diagnosis while retaining a visible Residence.
Morrow incorporates a Possum Hearth Annex and participates in ordinary care;
lasting amelioration remains governed by the Hearth's Rehabilitation
improvement rather than by Guest presence alone.

At thirty Citizens and eighteen Body Units, Barley conducts the Grand Manor
Recognition MEET. Rushbottom reads the names of its living Colony and the names
remembered from Chaff End while preserving uncertainty where memory failed.
The count has become an act of care rather than a claim of control.

The Civic Dedication spreads through reinforced joins, shaped thresholds,
ordered stores, shared furnishings, and accumulated detail. Recognition names
Rushbottom a **Grand Manor**. The title describes scale without making the Mice
large: its grandeur lies in many small rooms, short edges, nearby lives, and a
history dense enough that the first six Citizens remain recognizable within a
Colony of thirty.

#### Morningside — Squirrel

Morningside carries the Sourcebook's sustained Squirrel history. Rowan believes
survival requires reaching farther. Cobb believes reach without redundancy
magnifies loss. Gale keeps returning with observations that neither position
can possess alone.

| Recognition | Citizens first present by this Tier |
|---|---|
| **First Anchors** | Rowan; Cobb; Gale |
| **Linked Ways** | Tassel; Wick; Vane; Lilt |
| **Living Web** | Larch; Alder; Rivet; Reed; Latch |
| **Grand Web** | Rime; Spindle; Keel; Stillwater; The Goldwings; Gable |

##### Founding and First Anchors

Interchange work approaches Nine Beeches across two mornings before the
playable rupture reaches the ancestral Den. Rowan, Cobb, and Gale escape as
three Body Units. Rowan receives Focus and becomes the first Leader. Cobb tests
every uncertain foothold. Gale alone looks back.

After the final montage Crossing, the exhausted party enters Elmwater, a
Wooded Median shaped by mature trees, interrupted canopy, exposed gaps, and a
narrow drainage run. During the first quiet inspection of that ground, Gale
finds a length of weathered fishing line and keeps it as the first useful thing
the new Home gives them. Cobb carries a bent brass screw from Nine Beeches;
Rowan protects one pressed beech leaf.

The eastern side takes the light first. Rowan proposes **Morningside**. Cobb
would rather name the ground. Their argument enters the Colony before its first
Place.

Cobb leads the first Builder work. Workshop, Residence, and Garden occupy
distinct anchors whose connections make future alternatives visible. The first
Away return establishes the temptation of Squirrel Strained Carry: the party
accepts material beyond secured capacity, loses one loose piece to an immediate
Jostle result, and carries the rest Home. Morningside's recurring question is
already present—how much possibility can be carried before possibility itself
becomes unstable?

##### Linked Ways

Tassel arrives with a cheerful account whose harmless details change in every
...
way preserves access. The event makes Cobb's case materially persuasive without
making Rowan's outward ambition foolish. Subsequent work closes loops as well
as extending lines.

At seven Body Units, the Civic Dedication strengthens anchors, bindings, and
alternate ways throughout Home. Recognition names Morningside **Linked Ways**.

##### Living Web

Larch arrives from a failed Squirrel Colony, proving both that communities
exist beyond Morningside and that connection alone guarantees nothing. Alder
prefers low dependable ways to the highest possible line. Rivet turns every
human-made fragment over before deciding whether it belongs.

Reed opens Mink Water Reach when current, runoff, or flooded ground matters.
Latch opens Raccoon Latchwork when an accessible human-made closure enters the
situation. Their Signatures expand situated choices without making exploration
safe or automatic.

Gale inspects the location proposed for Morningside's first Outpost and returns
with two inseparable facts: the ground would extend the Colony's practical
range, and its first approach offers poor shelter. Rowan hears possibility;
Cobb hears the cost of reaching it. The player chooses when Home is stable
enough to commit Builder shares and Workshop capacity. The completed Outpost
extends rest, storage, and Colony synchronization without stationing a Citizen
there.

At twelve Body Units, Morningside's separate branches have become loops with
credible alternatives. Recognition names the durable Colony a **Living Web**.
The Rowan–Cobb argument remains useful because neither one describes every
future choice.

##### Grand Web

Rime and Spindle join the later generation. Keel brings Gull Long View and the
parallel Flyer expression to Away; the bird may receive a different visible
Crossing result without bypassing the ground party's RISK. Stillwater's Turtle
Residence inhabits one Water Garden without adding yield. The Goldwings'
Bumblebee Garden Cohabitation saves a Place and supplies its bounded half-yield
while the household sustains Gardener. Gable's Pigeon loft brings another
Leader into the Gathering Place without adding Practice Strength.

At eighteen Body Units, Rowan favors beginning recognition as soon as the
Civic Dedication is ready. Cobb asks what remains if the most prominent
connection fails. Spindle proposes another line, which the Colony chooses to
complete before the ceremony. That choice makes the present recognition
responsible; it does not resolve every future argument about reach.

Cobb changes from Builder to Leader and conducts the Grand Web Recognition
MEET. The Dedication strengthens primary ways, alternate lines, anchors,
landings, and sheltered connections throughout Home. Recognition names
Morningside a **Grand Web**.

Rowan's ambition made the distant Colony imaginable. Cobb's insistence made
its reach survivable. Gale's observations kept both accountable to the actual
world. Nine Beeches survives in a leaf, a screw, a remembered backward glance,
and the continuing question of how far a Colony can reach while remaining
connected to itself.
...
`Philosophy.Principle.LegibilityPrecedesAttachment`
...
`Philosophy.Pillar.AttachmentForward` · `Architecture.Cycle.HomeAwayReturn`
...
`Citizen.Citizen` · `Narrative.Memory`
...
`Home.Colony` · `Architecture.Cycle.HomeAwayReturn`
...
`Philosophy.Philosophy` · `Architecture.Cycle.HomeAwayReturn`

MEDIAN occupies two related positions. The theoretical desktop and console game
has a comparative field among colony simulations, settlement strategy,
character-driven games, animal-scale adventures, and ecological fiction. The
artifact that presently exists is an illustrated Concept Sourcebook whose
comparative field includes videogame design books, role-playing sourcebooks,
illustrated worldbooks, fictional field guides, and game-design fiction.

These positions must remain distinct. The Concept Sourcebook is the completed
present artifact. Its achievement is to make the theoretical game and world
sufficiently coherent, legible, and inhabitable that the book provides a
satisfying experience in its own right.

This Appendix establishes durable comparative relationships and positioning
language. Statements about projects currently released or in development are
contained in a visibly dated account and require fresh verification whenever
they are used outside this edition.

### Positioning the theoretical game

`Philosophy.Philosophy` · `Architecture.Cycle.HomeAwayReturn`

MEDIAN's clearest position arises from the relationship among Home, departure,
exposure, consequence, and return.

> **MEDIAN is an attachment-forward animal-colony strategy game about building
> one permanent Home in the median of a living highway, then deciding which
> named Citizens must leave its safety, cross a Roadway, and return changed.**

This statement gives the reader concrete subjects and actions before asking an
authored design term to carry meaning. **Attachment-forward** names the design
direction developed in § 1.2 and Appendix I, but it is not an established
market genre and should always be explained through what the game lets the
player know, value, remember, and protect.

| Positioning level | Preferred language | Function |
| --- | --- | --- |
| Public lead | Attachment-forward animal-colony strategy | Names the subject and design direction without implying an industrial city builder. |
| Formal genre | Ecological colony-and-expedition strategy game | Locates the complete Home-and-Away structure. |
| Secondary description | Narrative colony simulation | Signals named Citizens, persistent consequence, and Campaign Memory. |
| Milieu | Animal civilization in a living highway median | Establishes the defining territory in direct language. |
| Dramatic rhythm | Sanctuary → departure → exposure → consequence → return | States the recurring emotional and mechanical movement. |
| Emotional proposition | **MEDIAN earns its cozy.** | Places warmth as an achieved and particular condition rather than a universal guarantee. |

The formal genre label is useful after the concrete proposition is understood.
Used alone, *ecological colony-and-expedition strategy game* can sound more
abstract than MEDIAN feels and can conceal the named animals whose lives give
the systems weight.

### Cumulative distinctiveness

`Philosophy.Philosophy` · `Architecture.Cycle.HomeAwayReturn`

MEDIAN's position is cumulative. Each element has useful comparisons
elsewhere; their interdependence forms the proposition.

| Layer | MEDIAN's expression |
| --- | --- |
| Territory | A permanent animal civilization within the active infrastructure of a contemporary highway rather than a generic woodland or abandoned human ruin. |
| Home | One irreplaceable founding Colony whose Places, repairs, images, relationships, and memories accumulate across the campaign. |
| Citizens | A small named population whose members remain historically continuous and function as fractional player characters rather than anonymous labor units. |
| Species | Mouse, Rabbit, and Squirrel transform body scale, settlement form, Carry, Field movement, RISK, and the campaign's felt character. |
| Modes and Registers | One persistent world expressed through Home and Away, and through DWELL, TRAVEL, RISK, MEET, and EMBODY. |
| Departure and return | Particular Citizens leave visible absences, undergo exposure and consequence, and bring changed bodies, relationships, materials, and memories Home. |
| Civic life | Roles, Practices, Civic Balance, and the Project Queue create a non-industrial language of shared responsibility. |
| Sufficiency | Quiet Equilibrium makes stability, ordinary life, and successful stillness genuine outcomes rather than pauses before mandatory expansion. |
| Memory | Record, Chronicle, Tale, and canon imagery allow history to alter how Citizens, objects, Places, and the Colony are understood. |

The active highway is the immediate discovery hook. It must appear before
generic woodland-animal imagery can determine the comparison. The permanent
Home and its named lives then reveal the deeper proposition.

> **The highway makes MEDIAN recognizable. Return makes it matter.**

### Audience intersection

`Philosophy.Pillar.AttachmentForward`

MEDIAN brings several existing audiences into one work:

- settlement and colony-strategy players who value legible growth but want a
  destination other than industrial scale or perpetual optimization;
- players who remember particular simulated characters, injuries,
  relationships, objects, and emergent histories;
- readers of serious animal-scale fiction in which bodies and species remain
  consequential;
- players interested in ecological and environmental storytelling grounded in
  active human infrastructure;
- readers who value illustrated worlds, sourcebooks, maps, diagrams, and
  systems as cultural objects; and
- readers interested in game design as an expressive form even when no
  executable product accompanies the design.

Each audience supplies a recognizable point of entry. Their intersection
preserves the complete relationship among Colony, Citizen, Roadway, and
return.
...
Comparison serves several different purposes. Treating every neighboring work
as a competitor or every resemblance as an influence obscures more than it
clarifies.

| Class | Question |
| --- | --- |
| Current market neighbor | What might a contemporary reader or player compare from a title, store description, trailer, or screenshot? |
| Structural ancestor | What earlier work demonstrates a useful part of MEDIAN's game architecture? |
| Audience or tonal neighbor | What work attracts a related audience or creates a related emotional expectation despite different mechanics? |
| Milieu relative | What work shares animal scale, human infrastructure, road danger, refuge, or ecological attention? |
| Creative influence | What work actually shaped MEDIAN's authorial development? |
| Counter-comparable | What nearby design makes an illuminating opposite choice? |

A comparison establishes neither descent nor equivalence. Public positioning
should acknowledge meaningful overlap, state the boundary concretely, and
avoid absolute originality claims. The reviewed field distributes MEDIAN's
closest comparisons across several works.

### Current market field — verified 15 September 2026

`Philosophy.Philosophy`

This subsection records a changing field. Release state, feature descriptions,
and project direction must be verified again before reuse.

| Work | Why the comparison arises | MEDIAN's boundary |
| --- | --- | --- |
| [*Whiskerwood*](https://store.steampowered.com/app/2489330/Whiskerwood/) | The strongest screenshot and keyword collision: mice, elaborate settlements, individual colonists, survival, and expeditions. It entered Early Access on 6 November 2025 and is now an encountered product rather than a hypothetical future neighbor. | Its official proposition foregrounds complex production chains, automation, commodities, vertical industrial cities, cat oppression, and eventual rebellion. MEDIAN's Colony develops so that particular lives and their returns can matter; production remains bounded to that civic purpose. |
| [*Croakwood*](https://www.croakwood.com/) | Tiny animal townsfolk, visible daily routines, functional roles, customizable construction, exploration, and a relaxed woodland settlement make this the most important addition to the earlier survey. | Its presented center is frog town-building and management through gathering, crafting, decoration, and expansion into the forest. MEDIAN centers a small historical roster, an active Highway, distinct Home and Away responsibilities, and consequential return. |
| [*Luminids*](https://store.steampowered.com/app/4070510/Luminids/) | Its overhead colony planning and first-person entry into the built settlement create the strongest presentation-level comparison to a change of Register. Its announced Early Access date is February 2027. | Its public promise is an open colony sandbox without combat or game-over pressure. EMBODY is a bounded Home Register opened through Quiet Equilibrium, while TRAVEL and RISK carry animal bodies into credible danger. |
| [*Winter Burrow*](https://noodlecake.com/games/winter-burrow/) | A mouse restores a childhood Home, gathers beyond it, meets neighbors, and moves between warmth and a dangerous winter exterior. It offers the clearest current tonal-audience overlap. | One embodied protagonist drives an approachable survival adventure. MEDIAN's continuing subject is a Colony whose many Citizens can become individually known. |
| [*Hawthorn*](https://store.steampowered.com/app/4787870/Hawthorn_ProofofConcept_Demo/) | Anthropomorphic village life, memorable neighbors, building, farming, craft, exploration, seasons, and optional danger share a broad audience promise. | Its proof-of-concept presents an avatar-led sandbox role-playing experience. MEDIAN maintains collective stewardship and only enters individual company through the bounded EMBODY Register. |
| [*The Wandering Village*](https://store.steampowered.com/app/1121640/The_Wandering_Village/) | Constrained settlement space, hostile beauty, ecological dependence, changing conditions, and outward scouting provide a strong colony-plus-environment comparison. | Its settlement travels on a living creature and foregrounds production-chain adaptation. MEDIAN's founding Home remains fixed, and Away gains meaning through return to it. |

Several additional works create narrower points of comparison. *Ratopia* joins
animal city-building, individually differentiated citizens, policy, and
expeditions to an explicit economy of wealth, taxation, labor, and urban
prosperity. *Timberborn* joins species-shaped construction, verticality,
ecological hazard, and scavenged human material to automation, engineering,
terraforming, and mechanical production. *Grimshire* joins anthropomorphic
community, seasonal preservation, projects, and possible loss to a
player-character farming and life simulation. *Small Saga* and *Rain World*
offer especially useful animal-scale treatments of human infrastructure,
politics, vulnerability, and ecological danger while pursuing heroic or
nomadic forms far from MEDIAN's permanent civic Home.

The marketplace therefore produces several comparisons at once. Whiskerwood
may supply the first image comparison, Croakwood the animal-town comparison,
Luminids the viewpoint comparison, Winter Burrow the emotional comparison,
and The Wandering Village the colony-and-environment comparison. Positioning
should welcome this plurality rather than force one title to explain the whole
design.

### Structural ancestors and counter-comparables

`Architecture.Cycle.HomeAwayReturn`

The strongest mechanical lineage often lies outside animal games.

| Work | Durable contribution to comparison | Boundary |
| --- | --- | --- |
| [*This War of Mine*](https://store.steampowered.com/app/282070/This_War_of_Mine/) | The clearest broad predecessor for a shelter maintained at Home while particular civilians leave it, face danger, and return with resources and consequence. | Its dramatic engine is continuing civilian desperation. MEDIAN permits civic continuity, growth, care, ordinary life, and successful stillness. |
| [*RimWorld*](https://store.steampowered.com/app/294100/RimWorld/) | A definitive precedent for attachment through simulated needs, relationships, wounds, environmental events, travel, and strange individual history. | Its possibility space, body granularity, combat, psychology, and production systems are deliberately broader. MEDIAN uses a smaller authored grammar and a consciously bounded population. |
| [*Clanfolk*](https://store.steampowered.com/app/1700870/Clanfolk/) | One inhabited homestead, individual lives, family continuity, Guests, seasons, work, and preparation for winter make it an important Home-side neighbor. | Skills, lineage, labor, and production optimization organize its multigenerational survival. MEDIAN's Body Units, Civic Shares, Roles, and Campaign Memory pursue civic parity and attachment through different abstractions. |
| [*Wildermyth*](https://store.steampowered.com/app/763890/Wildermyth/) | Characters accumulate relationships, transformations, injury, age, sacrifice, retirement, memory, and later reappearance. | Its center is a heroic tactical party becoming legend. MEDIAN's Citizens become histories because they belong to a continuing Colony. |
| [*Against the Storm*](https://store.steampowered.com/app/1336490/Against_the_Storm/) | Multi-species settlement strategy, environmental Pressure, recurring events, expeditions, and strong city-building legibility make it an illuminating counter-comparable. | Its roguelite structure repeatedly founds, completes, and relinquishes settlements. MEDIAN makes one Home irreplaceable. |
| [*Of Life and Land*](https://store.steampowered.com/app/1733110/Of_Life_and_Land/) | Interdependent plants, animals, citizens, climate, and settlement activity offer a useful contemporary ecological-simulation comparison. | MEDIAN uses a selective ecological model in which relationships shape animal-scale territory, species expression, Pressure, opportunity, and consequence. |

These works clarify separate parts of MEDIAN: *This War of Mine* clarifies
departure and return; *RimWorld* and *Clanfolk* clarify attachment to an
inhabited settlement; *Wildermyth* clarifies accumulated personal history;
*Against the Storm* clarifies permanence by choosing its opposite.

### Creative lineage and market shorthand

`Philosophy.Pillar.AttachmentForward`

MEDIAN states its creative lineage directly in Part I. *Watership Down*
supplies its deepest emotional and dramaturgical foundation; *Mouse Guard*
informs animal-scale material culture, serious adventure, and sourcebook form;
and *Age of Empires* supplies the formative pleasure of legible civic growth.

Those relationships should remain honest influences rather than public
equations. “*Watership Down* meets *Age of Empires*” hides the distinctions
the Concept Sourcebook has worked to make: collective stewardship without
warfare, animal bodies without borrowed societies, and construction serving
attachment rather than technological ascent. Creative ancestry deserves
acknowledgment; it cannot substitute for describing the present design.

### Positioning the Concept Sourcebook

`Philosophy.Philosophy`

The Concept Sourcebook is the present work. It wraps the complete v0.5.0 game
design in a reader-facing visual and narrative form. Its rules, maps, tables,
prototypes, story Colonies, canon images, diagrams, and prose cooperate to make
the theoretical game available to imagination.

Nearby book forms each contribute part of its reading grammar:

| Book form | Useful precedent | MEDIAN's position |
| --- | --- | --- |
| Videogame art and design book | [*Sable: Design Works*](https://www.lostincult.co.uk/shop/p/sable-video-game-art-book-deluxe) and related design volumes demonstrate sustained visual authorship, annotated concepts, maps, development analysis, and highly designed physical presentation. | These books look backward from a completed game. MEDIAN's book is the primary completed expression of a theoretical one. |
| Illustrated worldbook or novel | [*Tales from the Loop*](https://designstudiopress.com/products/tales-from-the-loop), [*The Electric State*](https://www.simonandschuster.co.uk/books/The-Electric-State/Simon-Stalenhag/9781471176081), and *Dinotopia* demonstrate that image, prose, and a coherent world can constitute the principal experience. | MEDIAN also exposes rules, interfaces, state, choice, and systemic consequence. The imagined game is part of the world being made present. |
| Role-playing sourcebook or fictional field guide | [*A Field Guide to Hot Springs Island*](https://shop.swordfishislands.com/a-field-guide-to-hot-springs-island/) demonstrates the pleasure of a fictional territory made concrete and navigable through reference form. | MEDIAN borrows sourcebook density and navigation while describing a theoretical computer game rather than supplementing a playable tabletop system. |
| Fictional game manual and game-design fiction | [*Q1: Void*](https://droqen.itch.io/q1-void) demonstrates the imaginative experience of encountering a videogame through a manual that is itself the released work. | MEDIAN pursues full systemic and world coherence rather than nostalgic fragmentation or the deliberate mystery of a missing game. |

The resulting category is unusual but legible:

> **An illustrated Concept Sourcebook for a complete theoretical game, in
> which rules, world, narrative, interface, and artwork together make the game
> inhabitable in the reader's imagination.**

The term **Concept Sourcebook** therefore requires a short definition wherever
it first appears. It names a reader-facing theoretical design object whose
scope is complete without a software-production promise. The book is complete
when the reader can understand MEDIAN's Game Logic, imagine its lived play,
move confidently between overview and detail, and experience the world as more
than a collection of attractive images.

Several production choices protect that position:

- state the book's theoretical scope early;
- design every page while allowing many pages to rely on typography, tables,
  diagrams, and white space rather than illustration;
- remake useful visual concepts against current canon instead of treating
  obsolete artwork as authority;
- let narrative demonstrate systems without converting the whole book into
  fiction;
- preserve exact reference depth where it gives the imagined game credibility;
- use prototype images to communicate the Registers while identifying them as
  presentational illustrations; and
- make the book satisfying without implying that software realization is its
  deferred ending.

### Resemblance and misreading risks

`Philosophy.Pillar.AttachmentForward`

The greatest risk is convergence toward familiar neighbors in pursuit of
immediate legibility.

| Likely reading | Why it arises | Positioning protection |
| --- | --- | --- |
| “A cozy animal city builder” | Warm art, small dwellings, gardens, craft, and animal Citizens are immediately visible. | Show the active Highway, a named low population, departure, RISK, and Homecoming before generic settlement abundance determines the promise. |
| “Whiskerwood without cats” | Isometric rodent architecture creates an unavoidable first-image resemblance. | Preserve all three Core Species, non-industrial civic scale, the fixed median territory, and the Home/Away rhythm. |
| “A colony game with a first-person mode” | EMBODY can be mistaken for a camera feature comparable to Luminids. | Present EMBODY last among the Registers and explain Quiet Equilibrium, chosen company, bounded Home experiences, and attachment as its purpose. |
| “A RimWorld-like story generator” | Named Citizens, wounds, relationships, events, and persistent history suggest unrestricted simulation. | Describe the authored MEET grammar, Campaign Memory, low population, fractional-PC conception, and Conservation of Systems. |
| “A *Watership Down* or *Mouse Guard* game” | The influences are real and visually legible. | State the lineage while foregrounding MEDIAN's modern highway ecology, civic structure, three equal Core civilizations, and distinct Game Logic. |
| “A climate or ecology simulation” | Road ecology, Traffic as Weather, Biomes, and animal bodies are prominent. | Show ecology through decisions, territory, species experience, Pressure, and consequence rather than promising exhaustive natural simulation. |
| “A pitch book for a future product” | Concept art and a theoretical game can resemble preproduction presentation. | Name the Concept Sourcebook as the completed present artifact and give its prose, reference systems, narrative, and visual architecture full reader-facing form. |

A useful comparison opens a door while MEDIAN's own proposition determines
...
Any concise public account should reveal MEDIAN in this order:

1. **The place** — a living median within an active modern highway.
2. **The subject** — one permanent Colony and its small population of named
   animal Citizens.
3. **The rhythm** — build sanctuary, choose who leaves, cross and explore, and
   return with consequence.
4. **The species** — Mouse, Rabbit, and Squirrel create materially different
   civilizations and campaigns.
5. **The reward** — Quiet Equilibrium and EMBODY make ordinary life available
   to attention.
6. **The horizon** — the Colony and its Citizens become historically specific
   through Campaign Memory.

The setting should appear before a generic animal settlement can establish the
image. Return should appear before exploration can be mistaken for an end in
itself. EMBODY should appear after the strategy game that makes its quiet
meaningful.
...
> Mice, Rabbits, or Squirrels build one permanent Colony between the
> carriageways of an active modern highway. The player sustains its civic life,
> guides named Citizens into the world beyond Home, and lives with everything
> they bring back: materials, relationships, injuries, obligations, and
> memory.

**Concept Sourcebook**

> MEDIAN is an illustrated Concept Sourcebook for a complete theoretical game:
> an attachment-forward animal Colony strategy built around sanctuary,
> exposure, consequence, and return.

#### Language discipline

Prefer concrete language such as **one permanent Home**, **named Citizens**,
**living highway**, **colony-and-expedition**, **animal-scale**, **return**,
**Quiet Equilibrium**, and **Campaign Memory**. Use **attachment-forward** with
its definition. Use **highway-riparian** as authored analytical language after
the ordinary physical setting is clear.

Use **cozy**, **city builder**, **base builder**, **RTS**, **story generator**,
and **first-person mode** only with the qualification each requires. Private
comparisons such as “*RimWorld* with animals” or “*Watership Down* meets *Age
of Empires*” may expose one useful relationship during development but should
not become public definitions.

### Positioning acceptance test

`Philosophy.Philosophy`

The position is legible when a reader can explain:

1. why the active highway median is territory rather than backdrop;
2. why one permanent Home matters more than repeated settlement;
3. why Citizens are particular lives rather than a labor population;
4. why Home, Away, and Homecoming form one continuous game;
5. how Mouse, Rabbit, and Squirrel create distinct campaign experiences;
6. why Quiet Equilibrium and EMBODY are rewards of competent stewardship;
7. why Whiskerwood, Croakwood, Luminids, This War of Mine, RimWorld, and
   Wildermyth are each useful comparisons but none describes the whole;
8. how attachment-forward differs from a promise of continuous coziness; and
9. why the Concept Sourcebook is a completed theoretical design object rather
   than an announcement of software production.

MEDIAN occupies crowded neighboring shelves in a combination the reviewed
field does not duplicate: colony strategy without industrial destiny; animal
vulnerability without solitary survival; road ecology within active human
infrastructure; named personal history without heroic-party primacy; and
sanctuary as the reason the other systems matter.
