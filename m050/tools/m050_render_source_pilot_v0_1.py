...
def main() -> int:
    ...
    payload_blocks = [
        {
            ...
            "structural_disposition": ledger[block["block_id"]]["disposition"],
    ...
    payload = {
        "schema_version": "M050-PILOT-PAYLOAD-0.1",
    ...
    summary = {
        ...
        "eligible_blocks": sum(item["structural_disposition"] == "eligible" for item in payload_blocks),
        "context_only_blocks": sum(item["structural_disposition"] == "context_only" for item in payload_blocks),
