...
## HR-LIN-001 — Home Mode, Colony, and DWELL Specification begins v0.5

- **Date:** 2026-08-01
- **Class:** `LINEAGE`
- **Status:** `SETTLED`
- **Exact statement:** “These are the 4.7 docs before 0.5.0 Home Mode, Colony, and DWELL Specification, the first document of what I consider to be 0.5.”
- **Normalized ruling:** The uploaded intended-v0.4.7 documents predate the true v0.5 design generation. Home Mode, Colony, and DWELL Specification is the first document the designer considers genuinely v0.5, regardless of inherited filename or internal target labels.
- **Authority effect:** Corrects document genealogy and version classification.
- **Affected sources:** intended-v0.4.7 decisions; spatial review; Home Mode, Colony, and DWELL Specification; legacy concordance; future corpus manifest.
- **Semantic scope:** corpus lineage.

## HR-LIN-002 — v0.4.7 Cross-System Carryforward and BSA as contamination barriers

- **Date:** 2026-08-01
- **Class:** `LINEAGE`
- **Status:** `SETTLED`
- **Exact statement:** “Yes they're there as old, but the intention of v0.4.7 Cross-System Carryforward and the BSA (covering different phases of the 0.4.7 docs, along with maybe even one more spec?) was to preserve their learnings so they (047 decisions) didn't contaminate further development with old ideas.”
- **Normalized ruling:** v0.4.7 Cross-System Carryforward and the BSA work were created to salvage useful discoveries from the intended-v0.4.7 phase while preventing obsolete architecture from re-entering later v0.5 development.
- **Authority effect:** Quarantines original v0.4.7 sources after their surviving material is reconciled into current owners.
- **Affected sources:** V6/V7 decisions; v0.4.7 Cross-System Carryforward; BSA audit and ledgers; descendant specifications.
...
- **Affected sources:** Governing Philosophy and Architecture; MSID Grammar; Away; v0.4.7 Cross-System Carryforward; reconciliation correction rules; future registry.
...
- **Affected sources:** source-identity and reconciliation manifest v0.2; File Nomenclature Migration Ledger; repository links, indexes, scripts, and future documents.
- **Semantic scope:** file and build process only.
...
- **Affected sources:** Home; v0.4.6 GDD Coverage-Gap Development; legacy concordance; future Semantic Registry.
...
- **Affected sources:** Home; BSA ledgers; v0.4.6 GDD Coverage-Gap Development; legacy concordance; provisional namespace.
...
- **Affected sources:** Home; v0.4.6 GDD Coverage-Gap Development; legacy concordance; MSID Grammar; future Semantic Registry and Sourcebook.
...
- **Affected sources:** v0.4.7 Cross-System Carryforward; Away; BSA memory rulings; merged philosophy; legacy concordance.
...
- **Affected sources:** Authorial Grammar; MSID Grammar; source-identity and reconciliation manifest v0.2; Sourcebook; Phonebook.
...
- **Authority effect:** Promotes the current Outpost/Stopover section of v0.4.6 GDD Coverage-Gap Development within scope.
- **Affected sources:** v0.4.6 GDD Coverage-Gap Development; Away; v0.4.7 Cross-System Carryforward; legacy concordance; future corpus manifest.
...
- **Affected sources:** v0.4.6 GDD Coverage-Gap Development; Away; v0.4.7 Cross-System Carryforward; MSID Grammar; future Sourcebook.
- **Semantic scope:** `Away.Encounter.Stopover`; `Home.Encounter.Homecoming`.

## HR-AUTH-001 — v0.4.6 GDD Coverage-Gap Development is supplementary outside promoted scopes

- **Date:** 2026-08-01
- **Class:** `AUTHORITY_SCOPE`
- **Status:** `SETTLED`
- **Exact statement:** “Agree.”
- **Adopted proposition:** v0.4.6 GDD Coverage-Gap Development is supplementary and review-required overall; explicit human rulings may promote individual sections.
- **Normalized ruling:** v0.4.6 GDD Coverage-Gap Development has no blanket authority from its self-declared canonical language. Its default status remains supplementary and review-required outside specifically promoted domains.
- **Authority effect:** Constrains source authority while permitting scoped promotions.
- **Affected sources:** v0.4.6 GDD Coverage-Gap Development; future source-identity and reconciliation manifest.
...
- **Affected sources:** Ecological Influences; source-identity and reconciliation manifest; Home; Away; Crossing; Embodiment; Core Species Traits.
...
1. The source-identity and reconciliation manifest must cite this ledger when classifying Home Loop, v0.4.7 Cross-System Carryforward, BSA descendants, v0.4.6 GDD Coverage-Gap Development, and legacy sources.
