...
Emit exactly one disposition for every target block, in supplied input order, before returning.
Fewer, extra, duplicated, sampled, placeholder, or partially enumerated dispositions are invalid.
